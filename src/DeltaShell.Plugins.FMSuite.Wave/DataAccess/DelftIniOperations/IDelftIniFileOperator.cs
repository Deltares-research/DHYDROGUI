...
{
    /// <summary>
    /// <see cref="IDelftIniFileOperator"/> defines the interface to execute
    /// a set of <see cref="IDelftIniPropertyBehaviour"/> on a specified file.
    /// </summary>
    public interface IDelftIniFileOperator
    {
        /// <summary>
        /// Invokes the operations of this <see cref="IDelftIniFileOperator"/>
