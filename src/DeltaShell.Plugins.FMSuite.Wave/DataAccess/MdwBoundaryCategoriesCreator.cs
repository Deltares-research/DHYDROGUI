    ...
    public static class MdwBoundaryCategoriesCreator
    {
                                                             ...
                                                             IFilesManager filesManager)
        {
            ...
            foreach (IWaveBoundary boundary in boundaryContainer.Boundaries)
            {
                ...
                MdwBoundaryCategoryGeometryExtender.AddNewProperties(boundarySection, boundaryContainer, boundary.GeometricDefinition.SupportPoints);
                ...
                {
                    MdwBoundaryCategoryConditionsExtender.AddNewProperties(boundarySection, boundary.ConditionDefinition);
                }
