...
namespace DeltaShell.Plugins.DelftModels.WaterFlowModel
{
    public class WaterFlowModel1D350LegacyLoader : LegacyLoader
    {
        ...
        public override void OnAfterProjectMigrated(Project project)
        {
            ...
            {
                AdaptExistingUseThatcherHarlemanPropertyToNewDispersionFormulationTypeProperty(waterFlowModel1D);
                AdaptExistingDispersionCoverageToNewDispersionCoverages(waterFlowModel1D);
            }
        }

        private void AdaptExistingUseThatcherHarlemanPropertyToNewDispersionFormulationTypeProperty(WaterFlowModel1D waterFlowModel1D)
        {
        ...
        private void AdaptExistingDispersionCoverageToNewDispersionCoverages(WaterFlowModel1D waterFlowModel1D)
        {
