    ...
    public static class WaterFlowModel1DFileReader
    {
        ...
        public static WaterFlowModel1D Read(string modelFilename, Action<string, int, int> reportProgress = null)
        {
            ...
            try
            {
                ...
                BoundaryFileReader.ReadFile(fileName.BoundaryConditions, model.BoundaryConditions, model.Wind);
                BoundaryFileReader.ReadFile(fileName.BoundaryConditions, model.LateralSourceData);
