...
namespace DeltaShell.Plugins.DelftModels.WaterFlowModel.ImportExport
{
    public static class ModelDefinitionsRegion
    {
        ...
        public static readonly ConfigurationSetting InitialTemperature = new ConfigurationSetting(key: "InitialTemperature", description: "Initial temperature for locations where no spatial varying values is defined");
