...
namespace DeltaShell.Plugins.DelftModels.WaterFlowModel.ImportExport
{
    public class ModelFileNames
    {
        ...
        public ModelFileNames()
        {
            ...
            InitialDischarge = SpatialDataFileNames.InitialDischarge;
            InitialSalinity = SpatialDataFileNames.InitialSalinity;
            InitialTemperature = SpatialDataFileNames.InitialTemperature;
            InitialWaterLevel = SpatialDataFileNames.InitialWaterLevel;
            InitialWaterDepth = SpatialDataFileNames.InitialWaterDepth;
            Dispersion = SpatialDataFileNames.Dispersion;
            DispersionF3 = SpatialDataFileNames.DispersionF3;
            DispersionF4 = SpatialDataFileNames.DispersionF4;
            WindShielding = SpatialDataFileNames.WindShielding;
