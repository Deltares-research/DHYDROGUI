...
namespace DeltaShell.Plugins.DelftModels.WaterFlowModel.DataObjects
{
    ...
    public class WaterFlowModel1DBoundaryNodeData : FeatureData<IFunction, INode>, IItemContainer, IFeature
    {
        private WaterFlowModel1DBoundaryNodeDataType dataType;
        ...
        public WaterFlowModel1DBoundaryNodeData()
        {
        ...
        [FeatureAttribute]
        public virtual WaterFlowModel1DBoundaryNodeDataType DataType
        {
            get { return dataType; }
            set
            {
        ...
        public virtual InterpolationType InterpolationType
        {
            get
            {
                if (DataType == WaterFlowModel1DBoundaryNodeDataType.FlowConstant ||
        ...
        public IHydroNode Node
        {
            get { return Feature as IHydroNode; }
        }
        ...
        public object Clone()
        {
            var clonedWaterFlowModel1DBoundaryNodeData =
                (WaterFlowModel1DBoundaryNodeData) Activator.CreateInstance(GetType());
        ...
        private void SwitchToAppropriateType(IFunction value)
        {
            ...
            WaterFlowModel1DBoundaryNodeDataType targetType;
            if (value is TimeSeries)
            {
                targetType = WaterFlowModel1DHelper.GetTimeSeriesDataTypes(value).FirstOrDefault();
            }
            else if (value.Arguments.Count > 0 && value.Arguments[0].ValueType != typeof (DateTime))
            {
                targetType = WaterFlowModel1DBoundaryNodeDataType.FlowWaterLevelTable;
            }
            else
            {
        ...
        private void AfterSetWaterLevelOnly()
        {
            if (waterLevelOnly
                && !(DataType == WaterFlowModel1DBoundaryNodeDataType.WaterLevelConstant
                     ...
                     || DataType == WaterFlowModel1DBoundaryNodeDataType.None))
            {
                DataType = WaterFlowModel1DBoundaryNodeDataType.WaterLevelConstant; // Reset to water level
            }
        }
        ...
        private void SeriesDataItemLinking(object sender, LinkingUnlinkingEventArgs<IDataItem> e)
        {
            ...
            {
                DataType = WaterFlowModel1DHelper.GetTimeSeriesDataTypes(sourceTimeSeries).FirstOrDefault();
            }
        ...
        {
            if ((DataType == WaterFlowModel1DBoundaryNodeDataType.WaterLevelTimeSeries) ||
                (DataType == WaterFlowModel1DBoundaryNodeDataType.FlowTimeSeries))
            {
                return Data.Evaluate<double>(time);
            }
            if (DataType == WaterFlowModel1DBoundaryNodeDataType.WaterLevelConstant)
            {
                return WaterLevel;
            }
            if (DataType == WaterFlowModel1DBoundaryNodeDataType.FlowConstant)
