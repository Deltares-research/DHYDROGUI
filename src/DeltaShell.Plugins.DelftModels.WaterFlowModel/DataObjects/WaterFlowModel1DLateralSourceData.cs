...
namespace DeltaShell.Plugins.DelftModels.WaterFlowModel.DataObjects
{
    ...
    public class WaterFlowModel1DLateralSourceData : FeatureData<IFunction, LateralSource>, IItemContainer, IFeature
    {
        public const double DefaultSalinity = 0.0;

        private WaterFlowModel1DLateralDataType dataType;
        private IDataItem flowConstantDataItem;
        private IDataItem seriesDataItem;
        private bool useSalt;
        private bool useTemperature;

        public WaterFlowModel1DLateralSourceData()
        {
        ...
        public virtual WaterFlowModel1DLateralDataType DataType
        {
            get { return dataType; }
            set
            {
        ...
        public object Clone()
        {
            var clonedWaterFlowModel1DLateralSourceData = new WaterFlowModel1DLateralSourceData
                                                              {
                                                                  DataType = DataType,
                                                                  SeriesDataItem =
        ...
        private void SwitchToAppropriateType(IFunction value)
        {
            ...
            WaterFlowModel1DLateralDataType targetType;

            if (value is TimeSeries)
            {
                targetType = WaterFlowModel1DLateralDataType.FlowTimeSeries;
            }
            else if (value.Arguments.Count > 0 && value.Arguments[0].ValueType != typeof (DateTime))
            {
                targetType = WaterFlowModel1DLateralDataType.FlowWaterLevelTable;
            }
            else
            {
        ...
        private void SeriesDataItemLinking(object sender, LinkingUnlinkingEventArgs<IDataItem> e)
        {
            ...
            {
                DataType = WaterFlowModel1DLateralDataType.FlowWaterLevelTable;
            }
        }
