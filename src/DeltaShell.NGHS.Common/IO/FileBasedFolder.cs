...
namespace DeltaShell.NGHS.Common.IO
{
    ...
    public class FileBasedFolder : IFileBasedFolder
    {
        ...
        /// <paramref name="folderPath" /> contains invalid characters such as ", &, >, or |, or if <paramref name="folderPath"/> is empty.
        /// </exception>
        ...
        /// </exception>
        /// <remarks>If <paramref name="destinationPath"/> is <c>null</c> or empty or equals the current path, the method returns.</remarks>
        /// <remarks>If <paramref name="deleteIfExists"/> is <c>false</c> and the folder at <paramref name="destinationPath"/> exists, the source and destination directory are merged.</remarks>
        ...
        /// <exception cref="ArgumentException">
        /// <paramref name="newPath" /> contains invalid characters such as ", &, >, or |, or if <paramref name="newPath"/> is empty.
        /// </exception>
        /// <exception cref="PathTooLongException">
        /// The specified path, file name, or both exceed the system-defined maximum length.
        /// </exception>
