...
namespace DeltaShell.NGHS.Common.Properties {
    ...
    public class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The save state start time must be expressed by start time plus an positive integer multiple of the time step and before stop time..
        /// </summary>
        public static string RestartTimeRangeValidator_ValidateRestartTimeRangeSettings_The_save_state_start_time_must_be_expressed_by_start_time_plus_an_positive_integer_multiple_of_the_time_step_and_before_stop_time_ {
            get {
                return ResourceManager.GetString("RestartTimeRangeValidator_ValidateRestartTimeRangeSettings_The_save_state_start_t" +
                        "ime_must_be_expressed_by_start_time_plus_an_positive_integer_multiple_of_the_tim" +
                        "e_step_and_before_stop_time_", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to The save state stop time must be expressed by start time plus an positive integer multiple of the save state time step and not after stop time..
        /// </summary>
        public static string RestartTimeRangeValidator_ValidateRestartTimeRangeSettings_The_save_state_stop_time_must_be_expressed_by_start_time_plus_an_positive_integer_multiple_of_the_save_state_time_step_and_not_after_stop_time_ {
            get {
                return ResourceManager.GetString("RestartTimeRangeValidator_ValidateRestartTimeRangeSettings_The_save_state_stop_ti" +
                        "me_must_be_expressed_by_start_time_plus_an_positive_integer_multiple_of_the_save" +
                        "_state_time_step_and_not_after_stop_time_", resourceCulture);
            }
        }
