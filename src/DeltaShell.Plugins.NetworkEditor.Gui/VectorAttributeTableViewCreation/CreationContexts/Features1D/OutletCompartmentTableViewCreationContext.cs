...
namespace DeltaShell.Plugins.NetworkEditor.Gui.VectorAttributeTableViewCreation.CreationContexts.Features1D
{
    ...
    {
        /// <inheritdoc/>
        public string GetDescription() => "Outlet compartment table view";
        ...
        /// <inheritdoc/>
        public OutletCompartmentRow CreateFeatureRowObject(OutletCompartment feature)
        {
            Ensure.NotNull(feature, nameof(feature));
            return new OutletCompartmentRow(feature);
        }
