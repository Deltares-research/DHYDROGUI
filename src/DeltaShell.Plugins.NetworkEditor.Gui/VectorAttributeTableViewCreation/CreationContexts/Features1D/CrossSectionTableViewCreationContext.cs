...
namespace DeltaShell.Plugins.NetworkEditor.Gui.VectorAttributeTableViewCreation.CreationContexts.Features1D
{
    ...
    {
        /// <inheritdoc/>
        public string GetDescription() => "Cross section table view";
        ...
        /// <inheritdoc/>
        public CrossSectionRow CreateFeatureRowObject(ICrossSection feature)
        {
            Ensure.NotNull(feature, nameof(feature));
            return new CrossSectionRow(feature);
        }
