...
namespace DeltaShell.Plugins.NetworkEditor.Gui.VectorAttributeTableViewCreation.CreationContexts.Features2D
{
    ...
    /// enclosure, <see cref="GroupableFeature2DPolygon"/>, data.
    /// </summary>
    /// <seealso cref="GroupableFeatureTableViewCreationContext{GroupableFeature2DPolygon,GroupableFeature2DPolygonRow}"/>
    public class EnclosureTableViewCreationContext : GroupableFeatureTableViewCreationContext<GroupableFeature2DPolygon, GroupableFeature2DPolygonRow>
    {
        /// <inheritdoc/>
        public override string GetDescription() => "Enclosure table view";
        ...
        public override bool IsRegionData(HydroArea region, IEnumerable<GroupableFeature2DPolygon> data)
        {
            ...
            return ReferenceEquals(region.Enclosures, data);
        }
