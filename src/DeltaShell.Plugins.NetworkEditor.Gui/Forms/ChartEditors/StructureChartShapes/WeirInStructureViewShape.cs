    ...
    internal class WeirInStructureViewShape : CompositeShapeFeature
    {
        ...
        private IShapeFeature GetWeirShape()
        {
            ...
            if (weir.IsGated)
            {
                ...
                gatedWeirShape.AddHover(new HoverText(ParameterNames.CrestLevel, string.Format("{0:f2}m.", weir.CrestLevel),
                                                      gatedWeirShape.WeirShape, Color.Black, HoverPosition.Left,
                                                      ArrowHeadPosition.Top));
                gatedWeirShape.AddHover(new HoverText(ParameterNames.CrestWidth, string.Format("{0:f2}m.", weir.CrestWidth),
                                                      gatedWeirShape.WeirShape, Color.Black, HoverPosition.Bottom,
                                                      ArrowHeadPosition.LeftRight));
                gatedWeirShape.AddHover(new HoverText(ParameterNames.GateLowerEdgeLevel,
            ...
            else
            {
                if (weir.IsRectangle)
                {
                    ...
                    weirShapeFeature.AddHover(new HoverText(ParameterNames.CrestWidth, string.Format("{0:f2}m.", weir.CrestWidth),
                                                            weirShapeFeature.WaterShape, Color.Black, HoverPosition.Top,
                                                            ArrowHeadPosition.LeftRight));
                    weirShapeFeature.AddHover(new HoverText(ParameterNames.CrestLevel, string.Format("{0:f2}m.", weir.CrestLevel),
                ...
                else
                {
                    ...
                    freeFormatWeirShapeFeature.AddHover(new HoverText(ParameterNames.CrestWidth,
