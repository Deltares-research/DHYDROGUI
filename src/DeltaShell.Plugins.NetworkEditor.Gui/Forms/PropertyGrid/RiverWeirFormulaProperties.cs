...
namespace DeltaShell.Plugins.NetworkEditor.Gui.Forms.PropertyGrid
{
    internal class RiverWeirFormulaProperties : WeirFormulaProperties
    {
        ...
        public double CorrectionCoefficientPos
        {
            get
            {
                return RiverWeirFormula.CorrectionCoefficientPos;
            }
            set
            {
                RiverWeirFormula.CorrectionCoefficientPos = value;
            }
        }
        ...
        public double CorrectionCoefficientNeg
        {
            get
            {
                return RiverWeirFormula.CorrectionCoefficientNeg;
            }
            set
            {
                RiverWeirFormula.CorrectionCoefficientNeg = value;
            }
        }
        ...
        public double SubmergeLimitPos
        {
            get
            {
                return RiverWeirFormula.SubmergeLimitPos;
            }
            set
            {
                RiverWeirFormula.SubmergeLimitPos = value;
            }
        }
        ...
        public double SubmergeLimitNeg
        {
            get
            {
                return RiverWeirFormula.SubmergeLimitNeg;
            }
            set
            {
                RiverWeirFormula.SubmergeLimitNeg = value;
            }
        }
        ...
        private RiverWeirFormula RiverWeirFormula
        {
            get
            {
                return (RiverWeirFormula) weirFormula;
            }
        }
    }
}