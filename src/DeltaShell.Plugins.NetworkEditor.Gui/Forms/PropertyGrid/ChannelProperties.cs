...
namespace DeltaShell.Plugins.NetworkEditor.Gui.Forms.PropertyGrid
{
    ...
    public class ChannelProperties : ObjectProperties<IChannel>
    {
        ...
        public string Length
        {
            get
            {
                return string.Format("{0:0.##}", data.Length);
            }
            set
            {
                double result;
        ...
        public string GeometryLength
        {
            get
            {
                return string.Format("{0:0.##}", data.Geometry.Length);
            }
        }
        ...
        public string GeodeticLength
        {
            get
            {
                return string.Format("{0:0.##}", data.GeodeticLength);
            }
        }
        ...
        public bool IsLengthCustom
        {
            get
            {
                return data.IsLengthCustom;
            }
            set
            {
                data.IsLengthCustom = value;
            }
        }
        ...
        public int CrossSections
        {
            get
            {
                return data.CrossSections.Count();
            }
        }
        ...
        public int Structures
        {
            get
            {
                return data.Structures.Count(s => s.ParentStructure == null);
            }
        }
        ...
        public int BranchSources
        {
            get
            {
                return data.BranchSources.Count();
            }
        }
