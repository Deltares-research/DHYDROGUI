...
namespace DeltaShell.Plugins.NetworkEditor.Gui.Forms.PropertyGrid
{
    ...
    public class CrossSectionProperties : ObjectProperties<ICrossSection>
    {
        ...
        {
            bool isGeometryBased = data.CrossSectionType == CrossSectionType.GeometryBased;
        ...
        public string Branch
        {
            get
            {
                return data.Branch == null ? "<none>" : data.Branch.Name;
            }
        }
        ...
        public double GeometryChainage
        {
            get
            {
                return data.Branch.IsLengthCustom ? BranchFeature.SnapChainage(data.Branch.Geometry.Length, (data.Branch.Geometry.Length / data.Branch.Length) * data.Chainage) : data.Chainage;
            }
        }
        ...
        public string DefinitionId
        {
            get
            {
                return data.Definition.IsProxy ? data.Definition.Name : "";
            }
        }
        ...
        public double Thalweg
        {
            get
            {
                return Math.Round(data.Definition.Thalweg, 2);
            }
            set
            {
        ...
        public double LowestPoint
        {
            get
            {
                return data.Definition.LowestPoint;
            }
        }
        ...
        public double HighestPoint
        {
            get
            {
                return data.Definition.HighestPoint;
            }
        }
