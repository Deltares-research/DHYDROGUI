...
namespace DeltaShell.Plugins.NetworkEditor.Gui.Forms.PropertyGrid
{
    ...
    public class NetworkSegmentProperties : ObjectProperties<INetworkSegment>
    {
        ...
        public string Network
        {
            get
            {
                return data.Branch.Network.Name;
            }
        }
        ...
        public bool DirectionIsPositive
        {
            get
            {
                return data.DirectionIsPositive;
            }
        }
        ...
        public string StartChainage
        {
            get
            {
                return string.Format("{0:g6}", data.Chainage);
            }
        }
        ...
        public string EndChainage
        {
            get
            {
                return string.Format("{0:g6}", data.EndChainage);
            }
        }
        ...
        public string Length
        {
            get
            {
                return string.Format("{0:g6}", data.Length);
            }
        }
