...
namespace DeltaShell.Plugins.NetworkEditor.Gui.Forms.PropertyGrid
{
    internal class PierWeirFormulaProperties : WeirFormulaProperties
    {
        ...
        public int NumberOfPiers
        {
            get
            {
                return PierWeirFormula.NumberOfPiers;
            }
            set
            {
                PierWeirFormula.NumberOfPiers = value;
            }
        }
        ...
        public double UpstreamFacePos
        {
            get
            {
                return PierWeirFormula.UpstreamFacePos;
            }
            set
            {
                PierWeirFormula.UpstreamFacePos = value;
            }
        }
        ...
        public double UpstreamFaceNeg
        {
            get
            {
                return PierWeirFormula.UpstreamFaceNeg;
            }
            set
            {
                PierWeirFormula.UpstreamFaceNeg = value;
            }
        }
        ...
        public double DesignHeadPos
        {
            get
            {
                return PierWeirFormula.DesignHeadPos;
            }
            set
            {
                PierWeirFormula.DesignHeadPos = value;
            }
        }
        ...
        public double DesignHeadNeg
        {
            get
            {
                return PierWeirFormula.DesignHeadNeg;
            }
            set
            {
                PierWeirFormula.DesignHeadNeg = value;
            }
        }
        ...
        public double PierContractionPos
        {
            get
            {
                return PierWeirFormula.PierContractionPos;
            }
            set
            {
                PierWeirFormula.PierContractionPos = value;
            }
        }

        [DisplayName("PierContractionNeg")]
        [Description("Pier contraction coefficient Kp reverse direction")]
        public double PierContractionNeg
        {
            get
            {
                return PierWeirFormula.PierContractionNeg;
            }
            set
            {
                PierWeirFormula.PierContractionNeg = value;
            }
        }
        ...
        public double AbutmentContractionPos
        {
            get
            {
                return PierWeirFormula.AbutmentContractionPos;
            }
            set
            {
                PierWeirFormula.AbutmentContractionPos = value;
            }
        }
        ...
        public double AbutmentContractionNeg
        {
            get
            {
                return PierWeirFormula.AbutmentContractionNeg;
            }
            set
            {
                PierWeirFormula.AbutmentContractionNeg = value;
            }
        }
        ...
        private PierWeirFormula PierWeirFormula
        {
            get
            {
                return (PierWeirFormula) weirFormula;
            }
        }
    }
}