...
{
    /// <summary>
    /// Interaction logic for WaterFlowModel1DBoundaryNodeDataViewWpf.xaml
    /// </summary>
    public partial class WaterFlowModel1DBoundaryNodeDataViewWpf : IView
    {
        private readonly WaterFlowModel1DBoundaryNodeDataViewWpfViewModel viewModel = new WaterFlowModel1DBoundaryNodeDataViewWpfViewModel();
        
        public WaterFlowModel1DBoundaryNodeDataViewWpf()
        {
            InitializeComponent();
        ...
        public object Data
        {
            get { return viewModel.WaterFlowModel1DBoundaryNodeData; }
            set { viewModel.WaterFlowModel1DBoundaryNodeData = (WaterFlowModel1DBoundaryNodeData) value; }
        }
