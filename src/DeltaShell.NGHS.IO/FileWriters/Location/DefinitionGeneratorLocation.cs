...
namespace DeltaShell.NGHS.IO.FileWriters.Location
{
    public class DefinitionGeneratorLocation : IDefinitionGeneratorLocation
    {
        ...
        protected void AddCommonRegionElements(IBranchFeature branchFeature)
        {
            ...
            IniCategory.AddProperty(LocationRegion.Chainage.Key, branchFeature.Branch.CorrectlyRoundOffChainageIfChainageIsOnEndOfBranch(branchFeature.Chainage), LocationRegion.Chainage.Description, LocationRegion.Chainage.Format);
