...
namespace DeltaShell.NGHS.IO.FileWriters.Location
{
    public static class LocationRegion
    {
        ...
        public static readonly ConfigurationSetting Chainage = new ConfigurationSetting(key: "chainage", description: "Location on the branch (m)", format:"F3");
        ...
        public static readonly ConfigurationSetting PipeChainage = new ConfigurationSetting(key: "chainage", description: "Location on the branch (m)", format:"F3");
