...
namespace DeltaShell.NGHS.IO.FileWriters.Boundary
{
    ...
    public interface IStructureBoundaryGenerator
    {
        ...
        IEnumerable<IDelftIniCategory> GenerateBoundaries(IEnumerable<IStructureTimeSeries> structureData, DateTime startTime);
        ...
        IEnumerable<IDelftIniCategory> GenerateBoundary(string structureName, ITimeSeries structureData, DateTime startTime);
    }
}