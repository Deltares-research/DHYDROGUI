...
{
    /// <summary>
    /// <see cref="IBcCategoryParser"/> provides the help methods for parsing strings from Bc files.
    /// </summary>
    public interface IBcCategoryParser
    {
        /// <summary>
        ...
        double CreateConstant(IList<IDelftBcQuantityData> table, int lineNumber);
    }
}