...
namespace DeltaShell.NGHS.IO.Grid
{
    public class GridWrapper
    {
        ...
        [DllImport(GridApiDataSet.GRIDDLL_NAME, EntryPoint = "ionc_def_var", CallingConvention = CallingConvention.Cdecl)]private static extern int ionc_def_var_dll(ref int ioncid, ref int meshId, ref int networkId, ref int varId, ref int type, ref int locType, string varName, string standardName, string longName, string unit, ref int fillValueInt, ref double fillValue);
        ...
        public int DefineVariable(int ioNetCdfDataSetId, int meshId, int varId, int type, GridApiDataSet.LocationType locationType, string variableName, string standardName, string longName, string unit, double fillValue)
        {
        ...
        /// <param name="fillValue">Double precision fill value (in).</param>
        /// <returns>Result status (UG_NOERR==NF90_NOERR if successful).</returns>
        public int DefineNetworkVariable(int ioNetCdfDataSetId, int networkId, int varId, int type, GridApiDataSet.LocationType locationType, string variableName, string standardName, string longName, string unit, double fillValue)
        {
            int meshId = 0;          // dummy
            int fillValueInt = -999; // dummy
            var locType = (int)locationType;
        ...
        /// <returns>Result status (UG_NOERR==NF90_NOERR if successful).</returns>
        public int DefineNetworkVariable(int ioNetCdfDataSetId, int networkId, int varId, int type, GridApiDataSet.LocationType locationType, string variableName, string standardName, string longName, string unit, int fillValueInt)
        {
            int meshId = 0;            // dummy
