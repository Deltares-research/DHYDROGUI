...
namespace DeltaShell.NGHS.IO.Grid
{
    ...
    public class UGridNetwork : AGrid<IUGridNetworkApi>
    {
        ...
        {
            DoWithValidGridApi(uGridNetworkApi => uGridNetworkApi.WriteNetworkBranches(sourceNodeId, targetNodeId, branchLengths, nbranchgeometrypoints, branchIds, branchLongnames, branchOrderNumbers),
        ...
        {
            DoWithValidGridApi(uGridNetworkApi => uGridNetworkApi.WriteNetworkGeometry(geopointsX, geopointsY), 
        ...
        {
            string networkName;
            var uGridNetworkApi = GetValidGridApi(Resources.UGridNetwork_GetNetworkName_Couldn_t_obtain_the_network_name);
        ...
        public int GetNumberOfNetworkNodes(int networkId)
        {
            ...
            var uGridNetworkApi = GetValidGridApi(Resources.UGridNetwork_GetNumberOfNetworkNodes_Couldn_t_get_number_of_network_nodes);
        ...
        public int GetNumberOfNetworkBranches(int networkId)
        {
            ...
            var uGridNetworkApi = GetValidGridApi(Resources.UGridNetwork_GetNumberOfNetworkBranches_Couldn_t_get_the_number_of_network_branches);
        ...
        public int GetNumberOfNetworkGeometryPoints(int networkId)
        {
            ...
            var uGridNetworkApi = GetValidGridApi(Resources.UGridNetwork_GetNumberOfNetworkGeometryPoints_Couldn_t_get_the_number_of_network_geometry_points);
        ...
        {
            var uGridNetworkApi = GetValidGridApi(Resources.UGridNetwork_ReadNetworkNodes_Couldn_t_read_network_nodes);
        ...
        {
            var uGridNetworkApi = GetValidGridApi(Resources.UGridNetwork_ReadNetworkBranches_Couldn_t_read_network_branches);
        ...
        {
            var uGridNetworkApi = GetValidGridApi(Resources.UGridNetwork_ReadNetworkGeometry_Couldn_t_read_network_geometry);
