...
{
    public class UGridApi1DMesh : GridApi, IUGridApi1DMesh
    {
        private int meshId;
        ...
        public int Write1DMeshDiscretisationPoints(int[] branchIdx, double[] offset)
        {
            ...
            int numberOfMeshPoints = GetNumberOf1DMeshDiscretisationPoints();
        ...
        public int Read1DMeshDiscretisationPoints(out int[] branchIdx, out double[] offset)
        {
            ...
            var numberOfMeshPoints = GetNumberOf1DMeshDiscretisationPoints();
