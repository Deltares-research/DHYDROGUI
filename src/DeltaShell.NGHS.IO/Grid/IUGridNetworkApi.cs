...
namespace DeltaShell.NGHS.IO.Grid
{
    public interface IUGridNetworkApi : IGridApi, IDisposable
    {
        ...
        int WriteNetworkBranches(int[] sourceNodeId, int[] targetNodeId, double[] branchLengths, int[] nbranchgeometrypoints, string[] branchIds, string[] branchLongnames, int[] branchOrderNumbers);
