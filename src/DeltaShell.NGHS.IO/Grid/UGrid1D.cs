...
namespace DeltaShell.NGHS.IO.Grid
{
    public class UGrid1D : AGrid, IUGrid1D
    {
        ...
        public void Read1DNetworkNodes(int networkId, out double[] nodesX, out double[] nodesY, out string[] nodesIds, out string[] nodesLongnames)
        {
            IUGridApi1DNetwork uGridApi1D = GetValidIUGridApi1D();
            var ierr = uGridApi1D.Read1DNetworkNodes(networkId, out nodesX, out nodesY, out nodesIds, out nodesLongnames);
        ...
        public void Read1DNetworkBranches(int networkId, out int[] sourceNodes, out int[] targetNodes, out double[] branchLengths, out int[] branchGeoPoints, out string[] branchIds, out string[] branchLongnames)
        {
            IUGridApi1DNetwork uGridApi1D = GetValidIUGridApi1D();
            var ierr = uGridApi1D.Read1DNetworkBranches(networkId, out sourceNodes, out targetNodes, out branchLengths, out branchGeoPoints, out branchIds, out branchLongnames);
        ...
        public void Read1DNetworkGeometry(int networkId, out double[] geopointsX, out double[] geopointsY)
        {
            var uGridApi1D = GetValidIUGridApi1D();
            var ierr = uGridApi1D.Read1DNetworkGeometry(networkId, out geopointsX, out geopointsY);
            if (ierr != GridApiDataSet.GridConstants.IONC_NOERR)
            {
                throw new InvalidOperationException(
