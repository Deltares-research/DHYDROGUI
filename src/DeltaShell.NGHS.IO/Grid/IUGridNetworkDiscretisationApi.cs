namespace DeltaShell.NGHS.IO.Grid
{
    public interface IUGridNetworkDiscretisationApi : IGridApi
    {
        ...
        int WriteNetworkDiscretisationPointsIds(int numberOfDiscretisationPoints, string[] discretisationPointIds);
        ...
        int ReadNetworkDiscretisationPointIds(int meshId, out string[] ids);
    }
}