...
namespace DeltaShell.Plugins.DelftModels.RealTimeControl.Gui.Forms.PropertyGrid
{
    ...
    public class DirectionalConditionProperties : ObjectProperties<DirectionalCondition>
    {
        ...
        {
            get { return new DirectionalOperationConverter().OperationToString(data.Operation); }
            set { data.Operation = new DirectionalOperationConverter().StringToOperation(value); }
        }
    }
}
