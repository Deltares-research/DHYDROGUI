...
namespace DelftTools.Hydro.Helpers
{
    ...
    public static class StandardCrossSectionsFactory
    {
        public static CrossSectionDefinitionZW GetTabulatedCrossSectionFromTrapezium(
            double slope, double bedWidth, double topWidth, bool isClosed = false)
        {
            double height = (topWidth - bedWidth) / (2 * slope);
        ...
        /// <returns> </returns>
        public static CrossSectionDefinitionZW GetTabulatedCrossSectionFromArch(
        ...
        /// <param name="height"> </param>
        /// <returns> </returns>
        public static CrossSectionDefinitionZW GetTabulatedCrossSectionFromCunette(
            double width, double height, bool addClosingTopRow = true)
        {
            ...
            var lngdivision = (int) Math.Round((height / sngz) + 1);
            ...
            IEnumerable<HeightFlowStorageWidth> heightFlowStorageWidths =
                y.Select((t, i) => new HeightFlowStorageWidth(z[i], t, t));
        ...
        /// <returns> </returns>
        public static CrossSectionDefinitionZW GetTabulatedCrossSectionFromSteelCunette(
            double height, double radius, double radius1,
        ...
        /// <param name="height"> </param>
        /// <returns> </returns>
        public static CrossSectionDefinitionZW ProfileCunnetteGegolfd(double radius, double radius1, double radius2,
                                                                      double a, double height)
        {
            try
            {
                ...
                var lngdivision = (int) Math.Round((HB / sngz) + 1);

                var y = new List<double>();
                var z = new List<double>();
                double GKMIN;
                for (var lngX = 1; lngX <= lngdivision; lngX++)
                {
        ...
        /// <returns> </returns>
        public static CrossSectionDefinitionZW SetYZCentimetersToTabulatedProfile(
            IList<double> z, IEnumerable<double> y)
        {
            List<HeightFlowStorageWidth> hwwData = y.Select((t, i) =>
                                                                new HeightFlowStorageWidth(
                                                                    z[i] * 0.01, Math.Max(0.0000, t * 0.01),
                                                                    Math.Max(0.0000, t * 0.01))).ToList();
        ...
        /// <param name="height"> </param>
        /// <returns> </returns>
        public static CrossSectionDefinitionZW ProfileCunetteUf(double radius, double radius1, double radius2,
                                                                double radius3, double a, double a1, double height)
        {
            double r = radius * 100;
            double r1 = radius1 * 100;
            double r2 = radius2 * 100;
            ...
            var lngdivision = (int) Math.Round((H / sngz) + 1);
        ...
        public static CrossSectionDefinitionZW GetTabulatedCrossSectionFromRectangle(
            double width, double height, bool isClosed = false)
        {
