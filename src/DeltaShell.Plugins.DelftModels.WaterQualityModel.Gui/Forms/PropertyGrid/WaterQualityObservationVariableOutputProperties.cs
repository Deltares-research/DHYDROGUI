...
namespace DeltaShell.Plugins.DelftModels.WaterQualityModel.Gui.Forms.PropertyGrid
{
    ...
    public class WaterQualityObservationVariableOutputProperties : ObjectProperties<WaterQualityObservationVariableOutput>
    {
        [Category("General")]
        ...
        public int NoOutputVariables
        {
            get { return data.TimeSeriesList.Count(); }
        }
    }
}
