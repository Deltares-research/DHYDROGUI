...
namespace DeltaShell.Plugins.DelftModels.WaterQualityModel.Gui.Forms.ProjectExplorer
{
    ...
    {
        private static readonly Bitmap bordderImage = Properties.Resources.border_left;

        public override void UpdateNode(ITreeNode parentNode, ITreeNode node, IEventedList<WaterQualityBoundary> nodeData)
        {
