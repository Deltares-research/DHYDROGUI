...
namespace DeltaShell.Plugins.FMSuite.FlowFM.Gui.MapTools
{
    public class MergeEmbankmentsMapTool : MapTool
    {
        ...
        public override bool Enabled
        {
            get
            {
                return GetSelectedEmbankments().Count == 2;
            }
        }
        ...
        {
            ILayer embankmentDefinitionsLayer = Layers.FirstOrDefault(l => l.DataSource != null && l.DataSource.FeatureType == typeof(Embankment) && l.Name == HydroAreaLayerNames.EmbankmentsPluralName);
            ...
            List<Embankment> selectedEmbankments = GetSelectedEmbankments();
            ...
            Embankment mergedEmbankment = EmbankmentMerger.MergeSelectedEmbankments(embankmentDefinitions, selectedEmbankments[0], selectedEmbankments[1]);
        ...
        {
            IList<Embankment> allEmbankments = GetAllEmbankments();

            if (allEmbankments.Count == 0)
            {
                yield break;
            }

            var generateEmbankmentsMenu = new ToolStripMenuItem("Merge embankments", Resources.wrenchPlus, (s, e) => Execute()) {Enabled = GetSelectedEmbankments().Count == 2};
        ...
        {
            ILayer embankmentsLayer = Layers.FirstOrDefault(l => l.DataSource != null && l.DataSource.FeatureType == typeof(Embankment) && l.Name == HydroAreaLayerNames.EmbankmentsPluralName);
