...
namespace DeltaShell.Plugins.FMSuite.FlowFM.Gui.Editors
{
    public partial class BoundaryConditionEditor : UserControl, ICompositeView, IReusableView, ISuspendibleView
    {
        ...
        private FlowBoundaryConditionEditorController controller;
        private FlowBoundaryConditionPropertiesControl boundaryConditionPropertiesControl;
        ...
        public FlowBoundaryConditionEditorController Controller
        {
            get
            {
                return controller;
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public FlowBoundaryConditionPropertiesControl BoundaryConditionPropertiesControl
        {
            private get
            {
            ...
            set
            {
                ...
                if (boundaryConditionPropertiesControl != null)
                {
                    ...
                    boundaryConditionPropertiesControl.BoundaryCondition = SelectedBoundaryCondition as FlowBoundaryCondition;
