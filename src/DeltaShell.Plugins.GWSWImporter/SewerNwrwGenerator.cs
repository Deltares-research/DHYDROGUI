    ...
    public static class GwswNwrwGenerator 
    {
       public static NwrwSurfaceData CreateNewNwrwSurfaceData(GwswElement gwswElement)
        {
            ...
            nwrwSurface.Name = gwswElement.GetAttributeFromList(SewerConnectionMapping.PropertyKeys.UniqueId).ValueAsString;
            nwrwSurface.MeteoStationId = gwswElement.GetAttributeFromList(SewerConnectionMapping.PropertyKeys.MeteoStationId).ValueAsString;
            nwrwSurface.RunoffDefinitionFile = gwswElement.GetAttributeFromList(SewerConnectionMapping.PropertyKeys.RunoffDefinitionFile).ValueAsString;

            var surfaceType = gwswElement.GetAttributeFromList(SewerConnectionMapping.PropertyKeys.SurfaceId).ValueAsString.Trim();
            nwrwSurface.NwrwSurfaceType = (NwrwSurfaceType)typeof(NwrwSurfaceType).GetEnumValueFromDescription(surfaceType);
            ...
            nwrwSurface.Remark = gwswElement.GetAttributeFromList(SewerConnectionMapping.PropertyKeys.Remarks).ValueAsString;
       ...
       public static NwrwDischargeData CreateNewNwrwDischargeData(GwswElement gwswElement)
       {
           ...
           if (pollutinUnits.TryGetValueAsDouble(out auxDouble))
               nwrwDischargeData.NumberOfPeople = auxDouble;
       ...
       public static NwrwDefinition CreateNewNwrwRunoffDefinition(GwswElement gwswElement)
       {
           ...
           nwrwDefinition.SurfaceType = (NwrwSurfaceType) typeof(NwrwSurfaceType).GetEnumValueFromDescription(surfaceType);
           ...
           nwrwDefinition.Remark = gwswElement.GetAttributeFromList(SewerConnectionMapping.PropertyKeys.Remarks).ValueAsString;
       ...
       public static NwrwDryWeatherFlowDefinition CreateNewNwrwDryWeatherFlowDefinition(GwswElement gwswElement)
       {
           ...
           nwrwDryWeatherFlowDefinition.DryWeatherFlowId = gwswElement.GetAttributeFromList(SewerConnectionMapping.PropertyKeys.DistributionId).ValueAsString;
           ...
           nwrwDryWeatherFlowDefinition.DistributionType = (DwfDistributionType)typeof(DwfDistributionType).GetEnumValueFromDescription(distributionType);
           ...
           if (hourlyPercentage23.TryGetValueAsDouble(out auxDouble))
            ...
            nwrwDryWeatherFlowDefinition.Remark = gwswElement.GetAttributeFromList(SewerConnectionMapping.PropertyKeys.Remarks).ValueAsString;
