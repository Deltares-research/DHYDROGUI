...
namespace DeltaShell.Plugins.NetworkEditor.MapLayers
{
    public class HydroNetworkRoutesLayerController : IDisposable
    {
        ...
        private void NetworkRoutesCollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            switch (e.Action)
            {
                ...
                case NotifyCollectionChangedAction.Remove:
                    NetworkCoverageGroupLayer routeLayer = RoutesLayer.Layers.OfType<NetworkCoverageGroupLayer>().FirstOrDefault(rl => ReferenceEquals(rl.NetworkCoverage, removedOrAddedItem));
        ...
        {
            var routeLayer = new NetworkCoverageGroupLayer
            {
                NetworkCoverage = route,
                NameIsReadOnly = true
            };
