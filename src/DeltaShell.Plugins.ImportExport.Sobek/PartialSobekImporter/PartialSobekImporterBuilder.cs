...
namespace DeltaShell.Plugins.ImportExport.Sobek.PartialSobekImporter
{
    public static class PartialSobekImporterBuilder
    {
        ...
        public static IPartialSobekImporter BuildPartialSobekImporter(string networkFilePath, object obj)
        {
            ...
            var waterFlowModel1D = obj as WaterFlowModel1D;
            if (waterFlowModel1D != null)
            {
                return BuildWaterFlowModel1DImporter(networkFilePath, waterFlowModel1D);
            }
        ...
        private static IPartialSobekImporter BuildHydroModelImporter(string sobekPath, HydroModel hydroModel)
        {
            ...
            if (hydroModel.Activities.OfType<WaterFlowModel1D>().Any())
            {
                importers.AddRange(GetWaterFlowModel1DImporters());
            }
        ...
        private static IPartialSobekImporter BuildWaterFlowModel1DImporter(string sobekPath, WaterFlowModel1D waterFlowModel1D)
        {
            return BuildPartialSobekImporter(sobekPath, waterFlowModel1D, GetWaterFlowModel1DImporters());
        }
        ...
        private static IEnumerable<IPartialSobekImporter> GetWaterFlowModel1DImporters()
        {
