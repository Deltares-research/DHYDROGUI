...
namespace DeltaShell.Plugins.DelftModels.RTCShapes.Connections
{
	...
	/// http://netron.sf.net
	/// </summary>
    [Netron.GraphLib.Attributes.NetronGraphConnection("ConditionalConnection", "0CCF8556-3824-4a32-A5D7-64E017398EEA",
    ...
    public class ConditionalConnection : DefaultPainter
	{
        ...
        {
            var startPosition = Connection.From.ConnectionGrip();
