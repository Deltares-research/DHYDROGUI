...
namespace DeltaShell.Plugins.DelftModels.WaterQualityModel.Extentions
{
    public static class WaterQualityFunctionExtensions
    {
        ...
        {
            var f=  function is SegmentFileFunction;
            return f;
        }
        ...
        /// <param name="clearCoverage">Optional: indicate if coverage should be cleared.
        ...
        /// <para>This method does not update <see cref="ISpatialOperation"/> instances
        /// that might be applied to this particular coverage.</para>
        /// </remarks>
        public static void AssignNewGridToCoverage(this UnstructuredGridCellCoverage unstructuredGridCoverage, UnstructuredGrid grid, bool clearCoverage = true)
        {
        ...
        /// </summary>
        /// <remarks>Events are disabled during the clear as performance optimization for
        /// <see cref="MemoryFunctionStore"/> based coverages.</remarks>
        public static void ClearCoverage(this UnstructuredGridCellCoverage coverage)
        {
            ...
            var variables = coverage.Arguments.Concat(coverage.Components).ToList();
            ...
            var cellCount = coverage.Grid.Cells.Count;
