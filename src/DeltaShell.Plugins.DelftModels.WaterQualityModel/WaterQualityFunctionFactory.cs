...
namespace DeltaShell.Plugins.DelftModels.WaterQualityModel
{
    public static class WaterQualityFunctionFactory
    {
        ...
        public static IFunction CreateConst(string name, double defaultValue, string componentName, string componentUnitName, string description, string url=null)
        {
        ...
        /// <param name="componentUnitName">Unit name/symbol of the component</param>
        /// <param name="description">The description as found in the process library</param>
        public static IFunction CreateTimeSeries(string name, double defaultValue, string componentName, string componentUnitName, string description, string url=null)
        {
            var function = new Function(name);
            function.Attributes.Add(DESCRIPTION_ATTRIBUTE, description);
            var variable = new Variable<double>
            ...
            function.Components.Add(variable);
            function.Arguments.Add(new Variable<DateTime>("date time") { Unit = new Unit(RegionalSettingsManager.DateTimeFormat, RegionalSettingsManager.DateTimeFormat) });
        ...
        /// <param name="componentUnitName">Unit name/symbol of the component</param>
        /// <param name="description">The description as found in the process library.</param>
        public static IFunction CreateNetworkCoverage(string name, double defaultValue, string componentName, string componentUnitName, string description, string url=null)
        {
        ...
        /// <param name="componentUnitName">Unit name/symbol of the component</param>
        /// <param name="description">The description as found in the process library</param>
        public static IFunction CreateUnstructuredGridCellCoverage(string name, double defaultValue, string componentName, string componentUnitName, string description, string url=null)
        {
            var unstructuredGridCellCoverage = new UnstructuredGridCellCoverage(new UnstructuredGrid(), false) {Name = name};
        ...
        /// </summary>
        /// <remarks>No default value is set if the function does not contain any component or the first component is of the wrong type</remarks>
