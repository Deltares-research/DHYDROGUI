    ...
    public class WaqFileBasedPreProcessor : IWaqPreProcessor
    {
        ...
        public void WriteIncludeFilesAndBinaryFiles(WaqInitializationSettings initSettings, string includeDirectory)
        {
            ...
            var filesDictionary = new Dictionary<string, Func<WaqInitializationSettings, string>>
            {
                ...
                {
                    "B1_sublist.inc",
                    set => IncludeFileFactory.CreateSubstanceListInclude(set.SubstanceProcessLibrary)
                },
                ...
                {
                    "B4_nrofexch.inc",
                    set => IncludeFileFactory.CreateNumberOfExchangesInclude(
                ...
                {
                    "B4_cdispersion.inc",
                    set => IncludeFileFactory.CreateConstantDispersionInclude(
                ...
                {
                    "B5_boundlist.inc",
                    set => IncludeFileFactory.CreateBoundaryListInclude(set.BoundaryNodeIds, set.NumberOfLayers)
                },
                {
                    "B5_boundaliases.inc",
                    set => IncludeFileFactory.CreateBoundaryAliasesInclude(set.BoundaryAliases)
                },
                {
                    "B5_bounddata.inc",
                ...
                {"B6_loads.inc", set => IncludeFileFactory.CreateDryWasteLoadInclude(set.LoadAndIds)},
                {
                    ...
                    set => IncludeFileFactory.CreateDryWasteLoadAliasesInclude(set.LoadsAliases)
                },
                {
                    "B6_loads_data.inc",
                ...
                {
                    "B7_dispersion.inc",
                    set => IncludeFileFactory.CreateSpatialDispersionInclude(
                        set.Dispersion.First(), set.NumberOfLayers)
                },
                {
                    "B7_vdiffusion.inc",
                    set => IncludeFileFactory.CreateVerticalDiffusionInclude(
