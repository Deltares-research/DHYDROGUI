namespace DeltaShell.Plugins.DelftModels.WaterQualityModel.Model
{
    public interface IWaqModelApi
    {
        ...
        /// (must be as large as the number of segments)
        /// </param>
        ...
        /// </param>
        /// <param name="dispZeroFlow">
        /// DELWAQ uses flows and dispersion as specified (false) or
        /// it uses dispersions only if the flow is not zero (true)
        /// </param>
        ...
        bool SetWQIntegrationOptions(int method, bool dispZeroFlow, bool dispBound, bool firstOrder, bool forester,
                                     bool anticreep);
        ...
        /// 1 - Not to be used
        /// 2 - Mass balance
        /// 3 - Extended mass balance
        /// </param>
        /// <param name="lumpProcesses">
        /// Report contribution of all individual processes (false) or
        /// have them 'lumped' into a single term (true)
        /// </param>
        /// <param name="lumpLoads">
        /// Report contribution of all individual loads (false) or
        /// have them 'lumped' into a single term (true)
        /// </param>
        /// <param name="lumpTransport">
        /// Report contribution of all individual transports (false) or
        /// have them 'lumped' into a single term (true)
        /// </param>
        /// <param name="suppressSpace">
        /// Suppress output for individual monitoring points (segments) and
        /// monitoring areas (leaving only the overall mass balance term)
        /// </param>
        /// <param name="suppressTime">
        /// Suppress output for the monitoring time steps (leaving only the
        /// terms accumulated over time)
        /// </param>
        /// <param name="unitType">
        /// Unit type for mass balance
        ...
        /// </param>
        bool SetWQBalanceOutputOptions(int type, bool lumpProcesses, bool lumpLoads, bool lumpTransport,
        ...
        /// <param name="pointerTable">
        /// Defines exchange-surfaces between the cells
        /// <example>
        /// Segments: -1 | 1 | 2 | 3 | -2
        ...
        /// <param name="numberTransported">
        /// Number of active substances (<= <param name="numberSubstances" />
        /// )
        /// </param>
        /// <param name="processParameter"> Process parameters to use </param>
        /// <param name="numberParameters"> Number of
        ...
        /// <param name="value">
        /// First value is discharge rate (m3/s),
        /// other values are concentration of substances
        /// </param>
