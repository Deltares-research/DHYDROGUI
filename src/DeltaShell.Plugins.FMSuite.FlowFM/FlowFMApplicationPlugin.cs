        ...
        public override IEnumerable<IFileImporter> GetFileImporters()
        {
            ...
            yield return new PliFileImporterExporter<FixedWeir, FixedWeir>
            {
                ...
                AfterCreateAction = delegate(object featureList, FixedWeir fixedWeir)
                {
                    ...
                    {
                        Log.Warn($"Based on the Fixed Weir Scheme {scheme} too much columns are defined for {fixedWeir} in the imported fixed weir file. Last {difference} columns are ignored");
                    }

                    if (modelFeatureCoordinateData.DataColumns.Count > fixedWeir.Attributes.Count)
                    {
                        Log.Warn($"Based on the Fixed Weir Scheme {scheme} not enough columns are defined for {fixedWeir} in the imported fixed weir file. Last {difference} columns are generated by using default values");
                    }
