...
namespace DeltaShell.Plugins.FMSuite.FlowFM.Api
{
    ...
    public static class FlexibleMeshModelDll
    {
        ...
        [DllImport(DFLOWFM_DLL_NAME, EntryPoint = "get_version_string", CallingConvention = CallingConvention.Cdecl)]
        public static extern void get_version_string([Out] StringBuilder vers);

        [DllImport(DFLOWFM_DLL_NAME, EntryPoint = "get_start_time", CallingConvention = CallingConvention.Cdecl)]
        public static extern void get_start_time([Out] out double t);

        [DllImport(DFLOWFM_DLL_NAME, EntryPoint = "get_end_time", CallingConvention = CallingConvention.Cdecl)]
        public static extern void get_end_time([Out] out double t);

        [DllImport(DFLOWFM_DLL_NAME, EntryPoint = "get_current_time", CallingConvention = CallingConvention.Cdecl)]
        public static extern void get_current_time([Out] out double t);

        [DllImport(DFLOWFM_DLL_NAME, EntryPoint = "get_time_step", CallingConvention = CallingConvention.Cdecl)]
        public static extern void get_time_step([Out] out double dt);

        [DllImport(DFLOWFM_DLL_NAME, EntryPoint = "get_string_attribute", CallingConvention = CallingConvention.Cdecl)]
        public static extern void get_string_attribute([In] string name, [Out] StringBuilder value);

        [DllImport(DFLOWFM_DLL_NAME, EntryPoint = "update", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(DFLOWFM_DLL_NAME, EntryPoint = "get_var_location", CallingConvention = CallingConvention.Cdecl)]
        public static extern void get_var_location([In] string variable, [Out] StringBuilder location);

        [DllImport(DFLOWFM_DLL_NAME, EntryPoint = "get_var_shape", CallingConvention = CallingConvention.Cdecl)]
        public static extern void get_var_shape([In] string variable, [Out] int[] shape);

        [DllImport(DFLOWFM_DLL_NAME, EntryPoint = "get_var_rank", CallingConvention = CallingConvention.Cdecl)]
        public static extern void get_var_rank([In] string variable, [Out] out int rank);

        [DllImport(DFLOWFM_DLL_NAME, EntryPoint = "get_var_type", CallingConvention = CallingConvention.Cdecl)]
