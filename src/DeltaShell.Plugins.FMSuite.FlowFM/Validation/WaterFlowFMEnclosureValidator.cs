...
namespace DeltaShell.Plugins.FMSuite.FlowFM.Validation
{
    public class WaterFlowFMEnclosureValidator
    {
        public static ValidationReport Validate(WaterFlowFMModel model)
        {
            ...
            var enclosures = model.Area.Enclosures;
            ...
            if (enclosures.Count > 1)
            {
                ...
                issues.Add(new ValidationIssue(
                    ...
                    string.Format(Resources.WaterFlowFMEnclosureValidator_Validate_Only_one_enclosure_per_model_is_allowed__Enclosures_in_model___0_, enclosuresNames),
                    model.Area.Enclosures));
            }
            else
            {
        ...
        private static void CreateIssuesIfInvalidGeometry(List<ValidationIssue> issues, WaterFlowFMModel model, Feature2DPolygon feature )
        {
