...
namespace DeltaShell.Plugins.FMSuite.FlowFM.IO
{
    ...
    /// </summary>
    public class LateralSourceExtSection : ILateralSourceExtSection
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LateralSourceExtSection"/> class.
        /// </summary>
        ...
        /// </remarks>
        public LateralSourceExtSection(IniSection iniSection, ILogHandler logHandler = null)
        {
        ...
        private bool TryParseDouble(string doubleString, out double doubleVal)
        {
            ...
            logHandler?.ReportError($"Cannot parse '{doubleString}' to a double, see section on line {lineNumber}.");
            doubleVal = doubleVal2;
            return false;
        }
    }
