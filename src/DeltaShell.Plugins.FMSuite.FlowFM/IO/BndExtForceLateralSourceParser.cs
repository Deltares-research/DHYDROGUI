...
{
    /// <summary>
    /// Parses for lateral sources in the external forcing file.
    /// </summary>
    public class BndExtForceLateralSourceParser
    {
        ...
        /// </exception>
        public BndExtForceLateralSourceParser(string sourceFilePath, INetwork network, bool useSalt, bool useTemperature, ILogHandler logHandler = null)
        {
        ...
        private void SetDischargeFromBcFile(ILateralSourceExtCategory extCategory, Model1DLateralSourceData lateralSourceData)
        {
            ...
            else
            {
                ...
                bcDataByFile[bcFilePath] = BoundaryFileReader.ReadLaterSourcesFromBcFile(bcFilePath).ToDictionary(s => s.Name);
