    ...
    public static class ExtForceFileHelper
    {
                                                         ...
                                                         bool writeToDisk = true)
        {
            ...
            if (writeToDisk)
            {
                ...
                int count = boundaryCondition.Feature.Geometry.Coordinates.Count();
                ...
                for (var i = 0; i < count; ++i)
                {
                    ...
                    string dataFilePath = GetNumberedFilePath(pliFilePath, dataFileExtension, qhBoundary ? 0 : i + 1);
                                            ...
                                            out fileExtension))
                {
                    ...
                    foreach (string extension in splitExtension)
                    {
                        foreach (int dataFileNumber in dataFileNumbers)
                        {
                            ...
                            string dataFilePath = GetNumberedFilePath(filePath, extension, dataFileNumber);
                                                    ...
                                                    out string fileExtension)
        {
            ...
            if (cmpFileNumbers.Any())
            {
                ...
                conditionDataType =
                    new CmpFile().GetForcingType(GetNumberedFilePath(filePath, fileExtension, dataFileNumbers[0]));
                return true;
            }
        ...
        private static void ReadSourceAndSinkValues(SourceAndSink sourceAndSink, string filePath,
                                                    DateTime modelReferenceDate)
        {
                                                     ...
                                                     string fileExtension)
        {
            ...
            else
            {
                ...
                {
                    string expectedFileName = GetNumberedFilePath(fileNameOrPath, fileExtension, i);
