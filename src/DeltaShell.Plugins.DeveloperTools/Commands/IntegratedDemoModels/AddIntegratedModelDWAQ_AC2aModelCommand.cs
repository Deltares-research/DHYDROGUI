...
{
    public class AddIntegratedModelDWAQ_AC2aModelCommand : Command, IGuiCommand
    {
        ...
        protected override void OnExecute(params object[] arguments)
        {
            ...
            model.Name = "RR-FLOW demo model";
            // TODO: Remove this removal line once BuildEmptyModel respects given model names:
            var modelsToRemove = model.Activities.Where(m => !(m is WaterFlowModel1D || m is RainfallRunoffModel)).ToList();
        ...
        private void ConfigureHydroNetwork(HydroNetwork hydroNetwork)
        {
            ...
            var obsNearPipe = new ObservationPoint { Name = "Near pipe", Description = "O3", Geometry = new Point(branch1.Length + observationPointNearPipe, 0.0) };
