namespace DeltaShell.Plugins.DelftModels.RealTimeControl
{
    public static class RealTimeControlComplexTypeFiles
    {
        ...
        public const string XmlTools = @"rtcToolsConfig.xml";
        public const string XmlData = @"rtcDataConfig.xml";
        public const string XmlTimeSeries = @"timeseries_import.xml";
        public const string XmlImportState = @"state_import.xml";
    }
}