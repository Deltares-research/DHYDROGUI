...
{
    public partial class GatedWeirFormulaView : UserControl, IView
    {
        private GatedWeirFormula data;

        public GatedWeirFormulaView()
        {
            InitializeComponent();
        }
        ...
        public object Data
        {
            ...
            set
            {
                ...
                bindingSourceGatedWeirFormula.DataSource = data;
            }
        }
