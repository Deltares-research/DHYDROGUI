...
{
    public class AddNewWasteWaterTreatmentPlantCommand : Command
    {
        private IMapTool CurrentTool
        {
            get
            {
                return MapView.MapControl.GetToolByName(HydroRegionEditorMapTool.AddWasteWaterTreatmentPlantToolName);
            }
        }
