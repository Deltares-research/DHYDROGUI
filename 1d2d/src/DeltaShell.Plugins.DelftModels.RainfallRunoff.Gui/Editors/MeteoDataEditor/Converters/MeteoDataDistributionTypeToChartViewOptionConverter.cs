...
{
    /// <summary>
    /// <see cref="MeteoDataDistributionTypeToChartViewOptionConverter"/> provides the conversion from
    /// a <see cref="MeteoDataDistributionType"/> to the <see cref="ChartViewOptions"/> of the multiple function view.
    /// </summary>
    [ValueConversion(typeof(MeteoDataDistributionType), typeof(ChartViewOptions))]
    public class MeteoDataDistributionTypeToChartViewOptionConverter : IValueConverter
    {
        /// <inheritdoc />
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            return distributionType == MeteoDataDistributionType.Global 
                ? ChartViewOptions.AllSeries 
                : ChartViewOptions.SelectedColumns;
        }
