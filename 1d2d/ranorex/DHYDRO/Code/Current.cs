...
namespace DHYDRO.Code
{
    ...
    public static class Current
    {
        ...
        /// <summary>
        /// Gets the parameter from either the current smart folder, test case or the test suite.
        /// </summary>
        /// <param name="key">The parameter to get.</param>
        /// <returns>The parameter value.</returns>
        public static string GetParameter(string key)
        {
            return TS.CurrentTestContainer.Parameters.ContainsKey(key) 
                       ? TS.CurrentTestContainer.Parameters[key] 
                       : TS.Current.Parameters[key];
        }
    }
}