...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("7c4f813a-c9af-43c8-9eb7-b5d131eee240", ModuleType.Recording, 1)]
...
#region Variables
        ...
        /// </summary>
        [TestVariable("666b916c-f31e-496f-845b-22690b6a832a")]
        ...
        void ITestModule.Run()
        {
            ...
            Host.Current.CloseApplication(int.Parse(CloseAutProcessIDVar), 3000);
            Delay.Milliseconds(0);
            
            // Do not save project if this is asked
            Code.UserCodeLibrary.ClickIfExists(repo.DialogClosingProject.ButtonNoInfo, ValueConverter.ArgumentFromString<int>("waitPeriodInMilliSeconds", "10000"));
            Delay.Milliseconds(0);
