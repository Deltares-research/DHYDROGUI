...
% This script is to plot bed load sediment transport valong centerline of the FMstructured grid  and D3D in c30 folder
...
title('Bed load transport along the centreline -c30-47116')
grid on
d3d_qp('printfigure','C30_bedtransport_centreline-47116.png','PNG file',2,300,1,1,1)
%d3d_qp('closefigure')