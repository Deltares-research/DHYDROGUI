...
[Sediment]
	...
	IniSedThick 	        = 2.5000000e+000        # [m]           Initial sediment layer thickness at bed (uniform value or filename)
	...
	TraFrm                  = 1
        ...
        RouKs                   = 0.08
[Sediment]
	Name 			= #Sediment tracer# 	#		Name as specified in NamC in mdf-file
	SedTyp 			= bedload		#		Must be "sand", "mud" or "bedload"
	RhoSol 			= 2.65e+003 		# [kg/m3] 	Specific density
	SedDia 			= 5.0e-004 		# [m] 		Median sediment diameter (D50)
	CDryB 			= 1.6e+003 		# [kg/m3] 	Dry bed density
