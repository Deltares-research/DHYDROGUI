...
path1 = fullfile(cd, '..\..\..\c38_dad_dumpisdredge\DFM_OUTPUT_c38\c38_map.nc');
...
title('18-Feb-2000 00:20:00- C38-bedComparison-Dredge-dump')
grid on
d3d_qp('printfigure','C38-bedComparison-Dredge-dump.png','PNG file',2,300,1,1,1)
%d3d_qp('closefigure')