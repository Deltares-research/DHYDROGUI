...
path1 = fullfile(cd, '..\..\..\c36_dad_outside_dumping\DFM_OUTPUT_c36\c36_map.nc');
...
title('18-Feb-2000 00:20:00- C36-dumping-Outside')
grid on
d3d_qp('printfigure','C36-bedComparison.png','PNG file',2,300,1,1,1)
%d3d_qp('closefigure')