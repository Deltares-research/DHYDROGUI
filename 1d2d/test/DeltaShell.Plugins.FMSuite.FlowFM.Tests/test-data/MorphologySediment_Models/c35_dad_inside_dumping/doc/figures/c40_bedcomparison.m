...
path1 = fullfile(cd, '..\..\..\c40_dad_inside_dumping_layered_bed\DFM_OUTPUT_test\test_map.nc');
...
title('18-Feb-2000 00:20:00- C40-dredgedumpIn')
grid on
d3d_qp('printfigure','C40-bedComparison-dredgedumpIn.png','PNG file',2,300,1,1,1)
%d3d_qp('closefigure')