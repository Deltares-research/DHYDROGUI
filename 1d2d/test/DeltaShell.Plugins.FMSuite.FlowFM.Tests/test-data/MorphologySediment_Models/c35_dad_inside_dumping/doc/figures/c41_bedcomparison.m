...
path1 = fullfile(cd, '..\..\..\c41_dad_outside_dumping_layered_bed\DFM_OUTPUT_test\test_map.nc');
...
title('18-Feb-2000 00:20:00- C41-outsidedump')
grid on
d3d_qp('printfigure','C41-bedComparison-outsidedump.png','PNG file',2,300,1,1,1)
%d3d_qp('closefigure')