...
path1 = fullfile(cd, '..\..\..\c45_dad_inside_dumping_triangles\DFM_OUTPUT_da3\da3_map.nc');
...
d3d_qp('addtoplot')
box on
legend ('orginal-bed','strGrid-bed','UnstrGrid-bed', 'Location','SouthWest')
title('18-Feb-2000 00:20:00- C35-dumping-Inside')
grid on
d3d_qp('printfigure','C45triangles-bedComparison.png','PNG file',2,300,1,1,1)
%d3d_qp('closefigure')