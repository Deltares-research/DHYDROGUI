...
path1 = fullfile(cd, '..\..\..\c42_dad_2dredge1dump_layered_bed\DFM_OUTPUT_test\test_map.nc');
...
title('18-Feb-2000 00:20:00- C42-dredge(2)-dump(1)')
grid on
d3d_qp('printfigure','C42-bedComparison-dredge2dump1.png','PNG file',2,300,1,1,1)
%d3d_qp('closefigure')