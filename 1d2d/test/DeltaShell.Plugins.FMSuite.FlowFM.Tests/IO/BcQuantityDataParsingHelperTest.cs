...
namespace DeltaShell.Plugins.FMSuite.FlowFM.Tests.IO
{
    ...
    public class BcQuantityDataParsingHelperTest
    {
        ...
        [Test]
        public void GivenIncorrectDateTimeFormat_WhenParseDateTimes_ThenThrowFormatException()
        {
            //Arrange
            const string datetimeFormat = "seconds since incorrect-date incorrect-time";
            const string incorrectDatetimeFormat = "incorrect-date incorrect-time";
            ...
            //Act
            void Call() => BcQuantityDataParsingHelper.ParseDateTimes(locationName, quantityData);
        ...
        [Test]
        public void GivenIncorrectUnitAsBcQuantityData_WhenParseDateTimes_ThenReturnEmptyDateTimes()
        {
            var locationName = "Boundary1_0001";
            ...
            var quantityData = new BcQuantityData()
            {
                ...
                Unit = "Filled but Incorrect unit"
            };

            List<DateTime> dateTimes = BcQuantityDataParsingHelper.ParseDateTimes(locationName, quantityData).ToList();
            Assert.That(dateTimes, Is.EqualTo(Enumerable.Empty<DateTime>()));
        }
