...
namespace DeltaShell.Plugins.FMSuite.FlowFM.Tests
{
    ...
    partial class WaterFlowFMModelTest
    {
        ...
        [Test]
        public void GetModelDirectory_FilePropertyHasRelativePathUpwards_ReturnsModelDirectory()
        {
            var model = new WaterFlowFMModel { MduFilePath = @"c:\models\MyModel\dir1\dir2\dir3\FlowFM.mdu" };
