...
{
    [TestFixture]
    public class ThinDam2DTableViewCreationContextTest
    {
        [Test]
        public void GetDescription_ReturnsCorrectString()
        {
            ...
            // Assert
            Assert.That(result, Is.EqualTo("Thin dam 2D table view"));
        }
        ...
        [Test]
        public void IsRegionData_WhenRegionDoesNotContainThinDams_ReturnsFalse()
        {
            // Arrange
            var creationContext = new ThinDam2DTableViewCreationContext();
            var region = new HydroArea();
            region.ThinDams.AddRange(new ThinDam2D[3]);

            // Act
            bool result = creationContext.IsRegionData(region, new List<ThinDam2D>());
        ...
        [Test]
        public void IsRegionData_WhenRegionContainsThinDams_ReturnsTrue()
        {
            // Arrange
            var creationContext = new ThinDam2DTableViewCreationContext();
            var region = new HydroArea();
            ...
            // Act
            bool result = creationContext.IsRegionData(region, region.ThinDams);
        ...
        public void CreateFeatureRowObject_WhenFeatureNull_ThrowsArgumentNullException()
        {
            ...
            void Call()
            {
                creationContext.CreateFeatureRowObject(null, Enumerable.Empty<ThinDam2D>());
            }
        ...
        public void CreateFeatureRowObject_ALlFeaturesNull_ThrowsArgumentNullException()
        {
            ...
            void Call()
            {
                creationContext.CreateFeatureRowObject(new ThinDam2D(), null);
            }
        ...
        public void CreateFeatureRowObject_ReturnsNewRow()
        {
            // Arrange
            var creationContext = new ThinDam2DTableViewCreationContext();
            var feature = new ThinDam2D();

            // Act
            ThinDam2DRow result = creationContext.CreateFeatureRowObject(feature, Enumerable.Empty<ThinDam2D>());
