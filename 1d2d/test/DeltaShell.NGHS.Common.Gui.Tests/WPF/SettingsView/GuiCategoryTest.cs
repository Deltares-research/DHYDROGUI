...
namespace DeltaShell.NGHS.Common.Gui.Tests.WPF.SettingsView
{
    ...
    public class GuiCategoryTest
    {
        [Test]
        public void Test_WpfGuiCategory_With_Null_Attributes_DoesNot_Throw()
        {
            GuiCategory category = null;
            Assert.DoesNotThrow( () => category = new GuiCategory(null, null));
        ...
        public void Test_WpfGuiCategory_With_Name_DoesNot_Throw()
        {
            ...
            Assert.DoesNotThrow( () => category = new GuiCategory(dummyCategoryName, null));
            Assert.IsNotNull(category);
        ...
        {
            var dummyCategoryName = "dummyCategory";
            var category = new GuiCategory(dummyCategoryName, null);
            Assert.IsNotNull(category);
        ...
        public void Test_WpfGuiCategory_With_Properties_Creates_SubCategories()
        {
            ...
            var category = new GuiCategory(dummyCategoryName, propertyList);
            Assert.IsNotNull(category);
        ...
        {
            var dummyCategory = new GuiCategory("dummyCategory", null);
        ...
        public void Test_AddFieldUiDescription_Creates_Property_And_Adds_To_Existing_SubCategory()
        {
            ...
            var dummySubCategoryName = "dummySubCategory";
            var dummySubCategory = new GuiSubCategory(dummySubCategoryName, null);
