...
{
    [TestFixture]
    public class UserDefinedEvaporationFileTest
    {
        [Test]
        public void Constructor_InitializesInstanceCorrectly()
        {
            // Call
            var file = new UserDefinedEvaporationFile();
        ...
        {
            // Setup
            IEvaporationFile file = new UserDefinedEvaporationFile();
            ...
            var expEvaporationDate1 = new EvaporationDate(2022, date1.Month, date1.Day);
            var expEvaporationDate2 = new EvaporationDate(2022, date2.Month, date2.Day);
            var expEvaporationDate3 = new EvaporationDate(2022, date3.Month, date3.Day);
