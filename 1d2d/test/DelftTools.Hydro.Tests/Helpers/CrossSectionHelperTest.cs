...
namespace DelftTools.Hydro.Tests.Helpers
{
    ...
    public class CrossSectionHelperTest
    {
        ...
        {
            var upper = new[] { new Coordinate(0, 0), new Coordinate(1, 0), new Coordinate(2, 0), new Coordinate(3, 0) };
            var lower = new[] { new Coordinate(0, 3), new Coordinate(1, 3), new Coordinate(2, 3), new Coordinate(3, 3) };
        ...
        {
            var upper = new[] { new Coordinate(0, 0)};
            var lower = new[] { new Coordinate(0, 3)};
