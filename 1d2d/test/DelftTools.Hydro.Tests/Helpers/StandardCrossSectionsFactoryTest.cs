...
namespace DelftTools.Hydro.Tests.Helpers
{
    ...
    public class StandardCrossSectionsFactoryTest
    {
        ...
        public void GetTabulatedCrossSectionFromTrapezium()
        {
            ...
            var closingRow= crossSectionZWDataTable[0];
