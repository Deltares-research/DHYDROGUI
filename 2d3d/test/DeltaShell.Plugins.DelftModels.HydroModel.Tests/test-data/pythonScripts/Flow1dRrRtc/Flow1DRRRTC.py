...
integratedModel = CreateIntegratedModel([flowModel, rrModel, rtcModel], WorkingDir)
...
SetModelTimes(rtcModel, datetime(2016,1,1, 0,0,0), datetime(2016,1,1, 1,0,0), time(0,1,0))

rtcModel.OutputTimeStep = TimeSpan(0,1,0)
...
# Rename Project
Application.Project.Name = "Flow1D+RR+RTC"
...
observationpoint1 = CreateBranchObjectOnBranchUsingChainage(BranchObjectType.ObservationPoint, "observationpoint1", channel1, 35)
...
# add a lateral
lateral1 = CreateBranchObjectOnBranchUsingChainage(BranchObjectType.LateralSource, "lateral1", channel1, 20 )
...
timeSeries1 = [[datetime(2016, 1, 1, 0, 0, 0), 50.0],
...
obspoint = GetBranchObjectByType(flowModel.Network, BranchObjectType.ObservationPoint, "observationpoint2")
