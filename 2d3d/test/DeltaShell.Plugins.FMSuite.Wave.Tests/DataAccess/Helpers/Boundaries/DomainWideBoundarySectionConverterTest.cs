...
{
    [TestFixture]
    public class DomainWideBoundarySectionConverterTest
    {
        [Test]
        public void IsDomainWideBoundarySection_BoundarySectionsNull_ThrowsArgumentNullException()
        {
            // Call
            void Call() => DomainWideBoundarySectionConverter.IsDomainWideBoundarySection(null);
        ...
        {
            // Call
            bool isDomainWide = DomainWideBoundarySectionConverter.IsDomainWideBoundarySection(Enumerable.Empty<IniSection>());
        ...
        {
            // Call
            bool isDomainWide = DomainWideBoundarySectionConverter.IsDomainWideBoundarySection(new[]
            {
        ...
        public void IsDomainWideBoundaryCategory_WithNonDomainWideBoundarySection_DoesNotUpdateBoundariesPerFile(string definitionType)
        {
            ...
            // Call
            DomainWideBoundarySectionConverter.IsDomainWideBoundarySection(new[]
            {
                boundarySection
            });
        ...
        {
            // Call
            void Call() => DomainWideBoundarySectionConverter.Convert(null, Enumerable.Empty<IniSection>(), "path");
        ...
        {
            // Call
            void Call() => DomainWideBoundarySectionConverter.Convert(Substitute.For<IBoundariesPerFile>(), null, "path");
        ...
        {
            // Call
            void Call() => DomainWideBoundarySectionConverter.Convert(Substitute.For<IBoundariesPerFile>(), Enumerable.Empty<IniSection>(), null);
        ...
        public void Convert_WithNonDomainWideBoundarySection_DoesNotUpdateBoundariesPerFile(string definitionType)
        {
            ...
            // Call
            DomainWideBoundarySectionConverter.Convert(boundariesPerFile, new[]
            {
                boundarySection
            }, "path");
