...
namespace DeltaShell.NGHS.IO.Tests.FunctionStores
{
    ...
    public class MapHisFileReaderTest
    {
        ...
        public void TestMapFileReaderReadMetaData()
        {
            ...
            MapHisFileMetaData mapFileMetaData = MapHisFileReader.ReadMetaData(mapFilePath);
        ...
        public void TestMapFileReaderReadTimeStep()
        {
            string mapFilePath = Path.Combine(TestHelper.GetTestDataDirectory(), "FunctionStores", "deltashell.map");
            MapHisFileMetaData mapFileMetaData = MapHisFileReader.ReadMetaData(mapFilePath);
            List<double> valuesSalinity = MapHisFileReader.GetTimeStepData(mapFilePath, mapFileMetaData, 6, "Salinity");
            ...
            List<double> valuesOxy = MapHisFileReader.GetTimeStepData(mapFilePath, mapFileMetaData, 6, "OXY");
        ...
        public void TestMapFileReaderReadTimeStepForOneSegment()
        {
            string mapFilePath = Path.Combine(TestHelper.GetTestDataDirectory(), "FunctionStores", "deltashell.map");
            MapHisFileMetaData mapFileMetaData = MapHisFileReader.ReadMetaData(mapFilePath);
            List<double> valuesSalinity = MapHisFileReader.GetTimeStepData(mapFilePath, mapFileMetaData, 6, "Salinity", 1);

            Assert.AreEqual(1, valuesSalinity.Count);
            Assert.AreEqual(27.733558654785156, valuesSalinity[0]);

            List<double> valuesOxy = MapHisFileReader.GetTimeStepData(mapFilePath, mapFileMetaData, 6, "OXY", 1);
        ...
        {
            string path = Path.Combine(TestHelper.GetTestDataDirectory(), "FunctionStores", "flowhis.his");
            MapHisFileMetaData metaData = MapHisFileReader.ReadMetaData(path);
        ...
        public void ReadHisFile()
        {
            ...
            string path = Path.Combine(TestHelper.GetTestDataDirectory(), "FunctionStores", "flowhis.his");
            MapHisFileMetaData mapHisFileMetaData = MapHisFileReader.ReadMetaData(path);

            List<double> hisValues = MapHisFileReader.GetTimeSeriesData(path, mapHisFileMetaData, "Water level", mapHisFileMetaData.Locations.IndexOf("branch1_9000.00"));
        ...
        public void ReadOneTimeStep()
        {
            ...
            List<double> lstTimeStepValues = MapHisFileReader.GetTimeStepData(path, mapHisFileMetaData, 5, "Water level");
        ...
        public void ReadOneLocation()
        {
            ...
            List<double> lstLocationValues = MapHisFileReader.GetTimeSeriesData(path, mapHisFileMetaData, "Water level", 4);
        ...
        public void ReadOneLocation2ndCheck()
        {
            ...
            List<double> lstLocationValues = MapHisFileReader.GetTimeSeriesData(path, mapHisFileMetaData, "Total Area", 5);
