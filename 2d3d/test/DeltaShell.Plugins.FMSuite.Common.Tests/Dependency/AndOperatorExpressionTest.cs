...
namespace DeltaShell.Plugins.FMSuite.Common.Tests.Dependency
{
    ...
    public class AndOperatorExpressionTest
    {
        ...
        {
            var allExpressions = new List<DependencyExpressionBase> {new BooleanIsTrueDependencyExpression()};
            var expression = new AndOperatorExpression(allExpressions);
            allExpressions.Add(expression);
            ...
            ModelProperty propertyToBeComppiled = properties[3];
        ...
        {
            var allExpressions = new List<DependencyExpressionBase> {new ValueGreaterOrLesserThanDependencyExpression()};
            var expression = new AndOperatorExpression(allExpressions);
            allExpressions.Add(expression);
            ...
            ModelProperty propertyToBeComppiled = properties[2];
            ModelProperty propertyA = properties[0];
            ModelProperty propertyB = properties[1];
        ...
        {
            var allExpressions = new List<DependencyExpressionBase> {new ValueEqualsDependencyExpression()};
            var expression = new AndOperatorExpression(allExpressions);
            allExpressions.Add(expression);
