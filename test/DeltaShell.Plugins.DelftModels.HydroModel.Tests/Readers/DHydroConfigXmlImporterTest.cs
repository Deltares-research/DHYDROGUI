...
namespace DeltaShell.Plugins.DelftModels.HydroModel.Tests.Readers
{
    ...
    public class DHydroConfigXmlImporterTest
    {
        ...
        public void WhenImportItemIsCalledAndAnExpectedErrorIsThrown_ThenAMessageIsLoggedAndNullIsReturned(Type exceptionType)
        {
            ...
            string expectedMessage = string.Format(Resources.DHydroConfigXmlImporter_ImportItem_An_error_occurred_while_trying_to_import_a__0__, importer.Name);

            TestHelper.AssertLogMessageIsGenerated(() => result = (HydroModel)importer.ImportItem(path), expectedMessage, 1);
