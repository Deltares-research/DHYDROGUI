...
namespace DeltaShell.Plugins.DelftModels.HydroModel.Tests
{
    ...
    public class DHydroConfigModelCouplerTest
    {
        ...
        {
            IModel source = MockRepository.GenerateMock<IModel, IDimrModel>();
            ...
            IModel target = MockRepository.GenerateMock<IModel, IDimrModel>();
        ...
        public void CreateDHydroModelCouplerWithDimrCoupleInfoInDimrConfigModelCouplerAndCallUpdateModel()
        {
            ...
            string expectedCouperName = ((IDimrModel) sourceCoupler).ShortName + DimrConfigModelCouplerFactory.COUPLER_NAME_COMBINER + ((IDimrModel) target).ShortName;
