    ...
    public class FlowFmOutputFileComparer
    {
        ...
        public static void Compare(string[] expectedOutputFiles, string[] actualOutputFiles)
        {
            ...
            foreach (string fileName in allFileNames)
            {
                ...
                NetCdfFile actualNetCdfFile = NetCdfFile.OpenExisting(actualOutputFile, false);
                NetCdfFile expectedNetCdfFile = NetCdfFile.OpenExisting(expectedOutputFile, false);
                try
                {
                ...
                if (!sameDimensions || !sameVariables)
                {
                    identical = false;
                }
            }
        ...
        private static bool IsNetcdfFile(string fileName)
        {
