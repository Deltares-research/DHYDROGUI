...
namespace DeltaShell.Plugins.DelftModels.HydroModel.Tests.Forms.ActivityShapes
{
    ...
    public class ShapeFactoryTest
    {
        ...
        public void CreateSimpleActivityShape()
        {
            ...
            var shape = ShapeFactory.CreateShapeFromActivity(ActivityShapeTestHelper.CreateSimpleActivity(), graphControl);
        ...
        {
            var graphControl = new GraphControl { AllowDrop = false };
            var shape = ShapeFactory.CreateShapeFromActivity(new ParallelActivity { Name = "Test" }, graphControl);
        ...
        {
            var graphControl = new GraphControl { AllowDrop = false };
            var shape = ShapeFactory.CreateShapeFromActivity(new SequentialActivity{ Name = "Test" }, graphControl);
        ...
        {
            var graphControl = new GraphControl { AllowDrop = false };
            var shape = ShapeFactory.CreateShapeFromActivity(ActivityShapeTestHelper.CreateSimpleCompositeActivity(), graphControl);
