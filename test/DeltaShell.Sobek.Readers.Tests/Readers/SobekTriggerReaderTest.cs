...
namespace DeltaShell.Sobek.Readers.Tests.Readers
{
    ...
    public class SobekTriggerReaderTest
    {
        ...
        {
            var pathToSobekNetwork = TestHelper.GetTestDataDirectoryPathForAssembly(typeof(SobekWaterFlowModel1DImporterTest).Assembly, @"ndb_controllertriggerfiles\Trigger.def");
