...
namespace DeltaShell.Sobek.Readers.Tests.Readers
{
    ...
    public class SobekStructureDefFileReaderTest
    {
        ...
        public void ReadSobekWeirs()
        {
            ...
            string structureDefinitionFile = TestHelper.GetTestDataDirectoryPathForAssembly(typeof(SobekWaterFlowModel1DImporterTest).Assembly, @"Weir\struct.def");
        ...
        {
            //def file contains 6 different weirs
            string structureDefinitionFile = TestHelper.GetTestDataDirectoryPathForAssembly(typeof(SobekWaterFlowModel1DImporterTest).Assembly, @"Pump\TLS-1610litSTRUCT.DEF");
            var reader = new SobekStructureDefFileReader(SobekType.Sobek212);
        ...
        {
            string structureDefinitionFile = TestHelper.GetTestDataDirectoryPathForAssembly(typeof(SobekWaterFlowModel1DImporterTest).Assembly, @"NetworkWithStructures\struct.def");
            var reader = new SobekStructureDefFileReader(SobekType.Sobek212);
        ...
        public void ReadAllDefFilesShouldNeverCrash()
        {
            ...
            string dataDir = TestHelper.GetTestDataDirectoryPathForAssembly(typeof(SobekWaterFlowModel1DImporterTest).Assembly);
