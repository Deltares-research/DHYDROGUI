...
namespace DeltaShell.Sobek.Readers.Tests.Readers
{
    ...
    public class SobekMeasurementLocationReaderTest
    {
        ...
        {
            var pathToSobekNetwork = TestHelper.GetTestDataPath(typeof(SobekWaterFlowModel1DImporterTest).Assembly, @"ndb_controllertriggerfiles\NETWORK.ME");
        ...
        {
            var pathToSobekNetwork = TestHelper.GetTestDataPath(typeof(SobekWaterFlowModel1DImporterTest).Assembly, @"ndb_controllertriggerfiles\DEFSTR.4");
            var measurementLocations = new SobekMeasurementLocationReader().Read(pathToSobekNetwork).ToArray();
        ...
        {
            var pathToSobekNetwork = TestHelper.GetTestDataPath(typeof(SobekWaterFlowModel1DImporterTest).Assembly, @"ndb_controllertriggerfiles\DEFSTR.5");
            var measurementLocations = new SobekMeasurementLocationReader().Read(pathToSobekNetwork).ToArray();
