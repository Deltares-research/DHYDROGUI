...
{
    [TestFixture]
    public class MeteoDataDistributionTypeToAllowColumnsSortedConverterTest
    {
        private MeteoDataDistributionTypeToAllowColumnsSortedConverter Converter { get; set; }

        [SetUp]
        public void SetUp()
        {
            Converter = new MeteoDataDistributionTypeToAllowColumnsSortedConverter();
        }
        ...
        private static IEnumerable<TestCaseData> ConvertData()
        {
            ...
            yield return ToData(MeteoDataDistributionType.Global, true, nameof(MeteoDataDistributionType.Global));
            yield return ToData(MeteoDataDistributionType.PerFeature, false, nameof(MeteoDataDistributionType.PerFeature));
            yield return ToData(MeteoDataDistributionType.PerStation, false, nameof(MeteoDataDistributionType.PerStation));
        }
