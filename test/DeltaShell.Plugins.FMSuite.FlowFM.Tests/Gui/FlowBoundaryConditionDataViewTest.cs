...
namespace DeltaShell.Plugins.FMSuite.FlowFM.Tests.Gui
{
    ...
    public class FlowBoundaryConditionDataViewTest
    {
        ...
        public void ApplyThreeHarmonicValuesTest()
        {
            ...
            var resultA1 = (double) function.Arguments[0].Values[0];
            var resultC1 = (double) function.Components[0].Values[0];
            var resultC2 = (double) function.Components[1].Values[0];
        ...
        public void ApplyFiveHarmonicValuesTest()
        {
            ...
            var resultC1 = (double) function.Components[0].Values[0];
            var resultC2 = (double) function.Components[1].Values[0];
            var resultC3 = (double) function.Components[2].Values[0];
            var resultC4 = (double) function.Components[3].Values[0];
        ...
        public void ApplyIncorrectSixHarmonicValuesTest()
        {
            ...
            function.Components[4].SetValues(new[]
            {
                0.0
            });
        ...
        public void ApplyAstroComponentTest()
        {
            ...
            var expected = "Q1";
            var success = (bool) applyAstroComponentMethod.Invoke(typeof(bool), new object[]
            {
                new[]
                {
                    expected
            ...
            var result = (string) function.Arguments[0].Values[0];
            Assert.AreEqual(expected, result);

            var secondExpected = "AnotherComponent";
            var secondSucess = (bool) applyAstroComponentMethod.Invoke(typeof(bool), new object[]
            {
                new[]
                {
                    secondExpected
            ...
            var secondResult = (string) function.Arguments[0].Values[0];
