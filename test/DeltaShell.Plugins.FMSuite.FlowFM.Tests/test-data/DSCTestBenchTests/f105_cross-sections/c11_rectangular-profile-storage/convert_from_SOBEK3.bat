...
set inputfile=d:\05_Projects\05_27_FM_testing\testbench\cases\e02_dflowfm\f105_cross-sections\c11_rectangular-profile-storage\analysis\SOBEK_Model\rectangular_storage.md1d
