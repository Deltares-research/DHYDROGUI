...
%% Analysis of testcase https://repos.deltares.nl/repos/DSCTestbench/trunk/cases/e02_dflowfm/f105_cross-sections/c08_YZ-profile-storage
...
f_map = '..\..\DFM_OUTPUT_rectangular_storage\rectangular_storage_map.nc';
...
for i=1:t
    s1_T1 = s1_all((s1_all(:,1)== X_T1 & s1_all(:,2)== Y_T1),i+2);
    s1_T2 = s1_all((s1_all(:,1)== X_T2 & s1_all(:,2)== Y_T2),i+2);
    s1_T3 = s1_all((s1_all(:,1)== X_T3 & s1_all(:,2)== Y_T3),i+2);
    level = [s1_T1,s1_T2,s1_T3];
    Level(i,:) = [i,level];   
end

Point = ["Time Steps","s1_T1","s1_T2","s1_T3"];
