...
%% Analysis of testcase https://repos.deltares.nl/repos/DSCTestbench/trunk/cases/e02_dflowfm/f104_1D_numerical-aspects/c16_curved-channel-junction-advection-reference
...
h1_T4a = [h1.X(branch_id.Val==5), h1.Val(branch_id.Val==5)];
...
s1_T4a = [s1.X(branch_id.Val==5), s1.Val(branch_id.Val==5)];
...
Q1_T4_B2 = Q1_T4_After(1); 

Discharge = [Q1_T1_Before,Q1_T1_After,Q1_T2_B1,Q1_T2_B2,Q1_T3_B1,Q1_T3_B2,Q1_T4_B1,Q1_T4_B2];
Point = ["Q1_T1_Before","Q1_T1_After","Q1_T2_B1","Q1_T2_B2","Q1_T3_B1","Q1_T3_B2","Q1_T4_B1","Q1_T4_B2"];
...
u1_T4_B2 = u1_T4_After(1); 

Velocity = [u1_T1_Before,u1_T1_After,u1_T2_B1,u1_T2_B2,u1_T3_B1,u1_T3_B2,u1_T4_B1,u1_T4_B2];
Point = ["u1_T1_Before","u1_T1_After","u1_T2_B1","u1_T2_B2","u1_T3_B1","u1_T3_B2","u1_T4_B1","u1_T4_B2"];
