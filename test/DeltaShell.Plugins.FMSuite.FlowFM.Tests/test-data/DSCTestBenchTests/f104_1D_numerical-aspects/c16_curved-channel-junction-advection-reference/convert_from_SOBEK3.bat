...
set inputfile=d:\Projects\RHU\Tests\cases\e02_dflowfm\f104_1D_numerical-aspects\c16_curved-channel-junction-advection-reference\analysis\sobek\dflow1d\Flow1D.md1d
