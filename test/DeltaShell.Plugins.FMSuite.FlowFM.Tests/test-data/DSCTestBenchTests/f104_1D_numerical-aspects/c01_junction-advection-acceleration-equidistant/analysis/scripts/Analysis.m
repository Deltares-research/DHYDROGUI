...
var2 = 'Water level';
var3 = 'Discharge through flow link at current time - mesh1d_nEdges: sum';
var4 = 'Velocity at velocity point, n-component - mesh1d_nEdges: mean';
...
branch_id = qpread(FileInfo, 'Index of branch on which mesh nodes are located','data',0);
...
h1_T5 = [h1.X(branch_id.Val==10), h1.Val(branch_id.Val==10)];
h1_T6a = [h1.X(branch_id.Val==13), h1.Val(branch_id.Val==13)];
h1_T7a = [h1.X(branch_id.Val==17), h1.Val(branch_id.Val==17)];

Depth = [h1_T1(h1_T1(:,1)==X_cn,2), h1_T2(h1_T2(:,1)==X_cn,2),h1_T3(h1_T3(:,1)==X_cn,2),h1_T4a(h1_T4a(:,1)==X_cn,2), h1_T5(h1_T5(:,1)==X_cn,2), h1_T6a(h1_T6a(:,1)==X_cn,2), h1_T7a(h1_T7a(:,1)==X_cn,2)];
Point = ["h1_T1","h1_T2","h1_T3","h1_T4","h1_T5","h1_T6","h1_T7"];
...
s1_T5 = [s1.X(branch_id.Val==10), s1.Val(branch_id.Val==10)];
s1_T6a = [s1.X(branch_id.Val==13), s1.Val(branch_id.Val==13)];
s1_T7a = [s1.X(branch_id.Val==17), s1.Val(branch_id.Val==17)];

Level = [s1_T1(s1_T1(:,1)==X_cn,2), s1_T2(s1_T2(:,1)==X_cn,2), s1_T3(s1_T3(:,1)==X_cn,2), s1_T4a(s1_T4a(:,1)==X_cn,2),...
    s1_T5(s1_T5(:,1)==X_cn,2), s1_T6a(s1_T6a(:,1)==X_cn,2), s1_T7a(s1_T7a(:,1)==X_cn,2)];
Point = ["s1_T1","s1_T2","s1_T3","s1_T4","s1_T5","s1_T6","s1_T7"];
...
Q1_T5_B1 = Q1comp(find(Q1comp(:,2)==15000 & Q1comp(:,3) == 37000),5);
Q1_T5_After = Q1comp(find(Q1comp(:,1)==15000 & Q1comp(:,3) == 37000),5);
Q1_T5_B2 = Q1_T5_After(2);
Q1_T5_B3 = Q1_T5_After(1);

Q1_T6_Before = Q1comp(find(Q1comp(:,2)==15000 & Q1comp(:,4) == 39500),5);
Q1_T6_B1 = Q1_T6_Before(1); 
Q1_T6_B4 = Q1_T6_Before(2); 

Q1_T6_After = Q1comp(find(Q1comp(:,1)==15000 & Q1comp(:,3) == 39500),5);
Q1_T6_B2 = Q1_T6_After(2); 
Q1_T6_B3 = Q1_T6_After(1); 

Q1_T7_Before = Q1comp(find(Q1comp(:,2)==15000 & Q1comp(:,4) == 51500),5);
Q1_T7_B1 = Q1_T7_Before(1); 
Q1_T7_B4 = Q1_T7_Before(2); 

Q1_T7_After = Q1comp(find(Q1comp(:,1)==15000 & Q1comp(:,3) == 51500),5);
Q1_T7_B2 = Q1_T7_After(2); 
Q1_T7_B3 = Q1_T7_After(1); 
Discharge = [Q1_T1_Before,Q1_T1_After,Q1_T2_B1,Q1_T2_B2,...
    Q1_T3_B1,Q1_T3_B2,Q1_T3_B3,Q1_T4_B1,Q1_T4_B2,Q1_T4_B3,Q1_T4_B4,...
    Q1_T5_B1,Q1_T5_B2,Q1_T5_B3,Q1_T6_B1,Q1_T6_B2,Q1_T6_B3,Q1_T6_B4,...
    Q1_T7_B1,Q1_T7_B2,Q1_T7_B3,Q1_T7_B4];
Point = ["Q1_T1_Before","Q1_T1_After","Q1_T2_B1","Q1_T2_B2","Q1_T3_B1","Q1_T3_B2","Q1_T3_B3",...
    "Q1_T4_B1","Q1_T4_B2","Q1_T4_B3","Q1_T4_B4","Q1_T5_B1","Q1_T5_B2","Q1_T5_B3",...
    "Q1_T6_B1","Q1_T6_B2","Q1_T6_B3","Q1_T6_B4",...
    "Q1_T7_B1","Q1_T7_B2","Q1_T7_B3","Q1_T7_B4"];
...
u1_T5_B1 = u1comp(find(u1comp(:,2)==15000 & u1comp(:,3) == 37000),5);
u1_T5_After = u1comp(find(u1comp(:,1)==15000 & u1comp(:,3) == 37000),5);
u1_T5_B2 = u1_T5_After(2);
u1_T5_B3 = u1_T5_After(1);

u1_T6_Before = u1comp(find(u1comp(:,2)==15000 & u1comp(:,4) == 39500),5);
u1_T6_B1 = u1_T6_Before(1); 
u1_T6_B4 = u1_T6_Before(2); 

u1_T6_After = u1comp(find(u1comp(:,1)==15000 & u1comp(:,3) == 39500),5);
u1_T6_B2 = u1_T6_After(2); 
u1_T6_B3 = u1_T6_After(1); 

u1_T7_Before = u1comp(find(u1comp(:,2)==15000 & u1comp(:,4) == 51500),5);
u1_T7_B1 = u1_T7_Before(1); 
u1_T7_B4 = u1_T7_Before(2); 

u1_T7_After = u1comp(find(u1comp(:,1)==15000 & u1comp(:,3) == 51500),5);
u1_T7_B2 = u1_T7_After(2); 
u1_T7_B3 = u1_T7_After(1);

Velocity = [u1_T1_Before,u1_T1_After,u1_T2_B1,u1_T2_B2,u1_T3_B1,u1_T3_B2,...
    u1_T3_B3,u1_T4_B1,u1_T4_B2,u1_T4_B3,u1_T4_B4,...
    u1_T5_B1,u1_T5_B2,u1_T5_B3,u1_T6_B1,u1_T6_B2,u1_T6_B3,u1_T6_B4,...
    u1_T7_B1,u1_T7_B2,u1_T7_B3,u1_T7_B4];
Point = ["u1_T1_Before","u1_T1_After","u1_T2_B1","u1_T2_B2","u1_T3_B1","u1_T3_B2","u1_T3_B3",...
    "u1_T4_B1","u1_T4_B2","u1_T4_B3","u1_T4_B4","u1_T5_B1","u1_T5_B2","u1_T5_B3",...
    "u1_T6_B1","u1_T6_B2","u1_T6_B3","u1_T6_B4",...
    "u1_T7_B1","u1_T7_B2","u1_T7_B3","u1_T7_B4"];
