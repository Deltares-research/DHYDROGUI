...
namespace DeltaShell.Plugins.FMSuite.FlowFM.Tests
{
    ...
    internal class EmbankmentGeneratorTest
    {
        ...
        public void EmbankmentBasedOnTwoCrossSections()
        {
            ...
            // add cross-sections
            double side1 = Math.Sqrt(200.0);
            double side2 = Math.Sqrt(800.0);
            ...
            bool result = EmbankmentGenerator.GenerateEmbankmentsBasedOnCrossSection(network.Branches.Cast<Channel>().ToList(),
        ...
        public void EmbankmentPointsAtTwoZWCrossSections()
        {
            ...
            // add cross-sections
            double width1 = Math.Sqrt(800.0) * 2.0;
            double width2 = Math.Sqrt(200.0) * 2.0;
