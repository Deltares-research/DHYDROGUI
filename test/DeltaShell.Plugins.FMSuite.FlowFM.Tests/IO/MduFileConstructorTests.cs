...
namespace DeltaShell.Plugins.FMSuite.FlowFM.Tests.IO {
    ...
    public class MduFileConstructorTests
    {
        ...
        public void GivenMduFileConstruct_WhenInjectsCorrectIFlexibleMeshModelApiCallGetMyVersionString_ThenNotThrowAndLogErrorMessage()
        {
            ...
            // Act & Assert
            TestHelper.AssertLogMessageIsNotGenerated(() => new MduFile(api), string.Format(Resources.MduFile_MduFile_Error_retrieving_FM_Dll_version___0_, exceptionMessage) );
        ...
        public void GivenMduFileConstruct_WhenInjectsIncorrectIFlexibleMeshModelApiCallGetMyVersionString_ThenThrowAndLogErrorMessage()
        {
            ...
            Assert.That(TypeUtils.GetStaticField<string>(typeof(MduFile), staticFieldNameMduFileFMDllVersion), Is.EqualTo(Resources.MduFile_MduFile_Unknown));
        }
