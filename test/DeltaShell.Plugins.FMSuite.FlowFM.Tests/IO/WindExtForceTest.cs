...
namespace DeltaShell.Plugins.FMSuite.FlowFM.Tests.IO
{
    ...
    public class WindExtForceTest
    {
        ...
        public void WriteReadUniformForcings()
        {
            ...
            windXField.Data.Arguments[0].SetValues(new[]
            {
                refDate,
                refDate.AddHours(6),
                refDate.AddHours(12)
            });
            windXField.Data.Components[0].SetValues(new[]
            {
                -2.5,
                0.0,
                1.5
            ...
            windYField.Data.Arguments[0].SetValues(new[]
            {
                refDate,
                refDate.AddHours(6),
                refDate.AddHours(12)
            });
            windYField.Data.Components[0].SetValues(new[]
            {
                -1.5,
                0.0,
                2.5
            ...
            windXField2.Data.Arguments[0].SetValues(new[]
            {
                refDate,
                refDate.AddHours(6),
                refDate.AddHours(12)
            });
            windXField2.Data.Components[0].SetValues(new[]
            {
                0.05,
                0.05,
                0.0
            ...
            windPolarField.Data.Arguments[0].SetValues(new[]
            {
                refDate,
                refDate.AddHours(6),
                refDate.AddHours(12)
            });
            windPolarField.Data.Components[0].SetValues(new[]
            {
                1.5,
                1.0,
                0.88
        ...
        public void WriteReadUniformForcingWithSpiderWeb()
        {
            ...
            windXYField.Data.Arguments[0].SetValues(new[]
            {
                refDate,
                refDate.AddHours(6),
                refDate.AddHours(12)
            });
            windXYField.Data.Components[0].SetValues(new[]
            {
                -2.5,
                0.0,
                1.5
        ...
        private void CompareWindFields(IWindField firstWindField, IWindField secondWindField)
        {
            ...
            else
            {
                ...
                for (var i = 0; i < firstWindField.Data.Arguments.Count; ++i)
                {
                    CompareVariables(firstWindField.Data.Arguments[i], secondWindField.Data.Arguments[i]);
                }

                for (var i = 0; i < secondWindField.Data.Components.Count; ++i)
                {
