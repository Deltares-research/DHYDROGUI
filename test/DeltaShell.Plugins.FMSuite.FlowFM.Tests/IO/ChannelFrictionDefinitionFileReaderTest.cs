...
namespace DeltaShell.Plugins.FMSuite.FlowFM.Tests.IO
{
    ...
    public class ChannelFrictionDefinitionFileReaderTest
    {
        ...
        private static IEnumerable<ChannelFrictionDefinition> GetExpectedChannelFrictionDefinitions(IEnumerable<IBranch> branches)
        {
            ...
            cfd6.SpatialChannelFrictionDefinition.Function.Arguments[0].SetValues(new double[] {1, 2});
            cfd6.SpatialChannelFrictionDefinition.Function.Arguments[1].SetValues(new double[] {3, 4});
            cfd6.SpatialChannelFrictionDefinition.Function.Components[0].SetValues(new double[] {5, 6, 7, 8});
            ...
            Assert.That(channelFrictionDefinitions.Count, Is.EqualTo(11));
