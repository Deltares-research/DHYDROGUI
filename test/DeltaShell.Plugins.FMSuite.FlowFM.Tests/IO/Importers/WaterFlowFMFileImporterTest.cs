...
namespace DeltaShell.Plugins.FMSuite.FlowFM.Tests.IO.Importers
{
    ...
    public class WaterFlowFMFileImporterTest
    {
        ...
        public void GivenGeneralStructureMduFileWithUnhandledType_WhenImportItem_ThenNotImplementedExceptionThrown()
        {
            ...
            Assert.That(renderedMessages[5].Contains(structureFactoryException));
        ...
        public void GivenGeneralStructureMduFileWithUnhandledType_WhenImportItem_ThenLoggedExpectedMessages()
        {
            ...
            // Then
            Assert.That(renderedMessages[3].Contains(convertStructureError), Is.True, $"Not found error message: {convertStructureError}\n Log messages: {renderedMessages[3]}");
            Assert.That(renderedMessages[4].Contains(structuresFileError), Is.True, $"Not found error message: {structuresFileError}\n Log messages: {renderedMessages[4]}");
            Assert.That(renderedMessages[5].Contains(waterFlowFmFileImporterError), Is.True, $"Not found error message: {waterFlowFmFileImporterError}\n Log messages: {renderedMessages[5]}");
            Assert.That(renderedMessages[5].Contains(structureFactoryException), Is.True, $"Not found error message: {structureFactoryException}\n Log messages: {renderedMessages[5]}");
        }
