    ...
    public class WaterFlowFMMduFileTest
    {
        ...
        public void MduFileReadsAndWritesMultipleLinePropertiesIncludingComments(string fileCategoryName, string propertyName, string expectedValues, string expectedOutputComments, string rawValuesAndComments)
        {
            ...
            try
            {
                ...
                //Read
                mduFile.Read(mduFilePath, modelDefinition, new HydroArea(), new HydroNetwork(), null, null, null,  allFixedWeirsAndCorrespondingProperties);
        ...
        public void MduFileReadsAndWritesIGroupableFeatures()
        {
            ...
            try
            {
                ...
                var allFixedWeirsAndCorrespondingProperties = new List<ModelFeatureCoordinateData<FixedWeir>>();
                mduFile.Read(mduFilePath, originalMD, originalArea, originalNetwork, null, null, null, allFixedWeirsAndCorrespondingProperties);
                mduFile.Write(savePath, originalMD, originalArea, null, null, null, null, null, allFixedWeirsAndCorrespondingProperties, switchTo: false);
                ...
                mduFile.Read(savePath, savedMD, savedArea, savedNetwork, null, null, null, allFixedWeirsAndCorrespondingProperties);
        ...
        public void MduFileReadsAndWritesXyzFileDryPointFeature()
        {
            ...
            try
            {
                ...
                mduFile.Write(savePath, originalMd, originalArea, null, null, null, null, null, allFixedWeirsAndCorrespondingProperties, switchTo: false, writeExtForcings: false);
        ...
        public void GivenTwoFeaturesWithNameThatDifferByACapitalLetter_WhenWritingMduFile_ThenBothAreWrittenToTheSameFile(string firstGroupName, string secondGroupName, bool fileShouldAlreadyExists)
        {
            ...
            var modelDefinition = new WaterFlowFMModelDefinition(mduDir, modelName);
            var allFixedWeirsAndCorrespondingProperties = new List<ModelFeatureCoordinateData<FixedWeir>>();
            TestHelper.AssertAtLeastOneLogMessagesContains(() => mduFile.Write(mduFilePath, modelDefinition, area, null, null, null,null, null, allFixedWeirsAndCorrespondingProperties),
        ...
        public void GivenModelWithOneDryAreaAndOneDryPoint_WhenWritingAndReadingMduFile_ThenBothFeaturesArePresent()
        {
            ...
            var network = new HydroNetwork();
            mduFile.Read(mduFilePath, modelDefinition, newArea, network, null, null, null, allFixedWeirsAndCorrespondingProperties);
        ...
        public void GivenMduFileReferencingAnExistingFeatureFile_WhenLoadingAndRenamingTheFeatureWithARelativePath_ThenReferenceInMduFileIsDeleted()
        {
            ...
            mduFile.Write(mduPath, modelDefinition, area, null, null, null,null, null, allFixedWeirsAndCorrespondingProperties);
        ...
        public void GivenAbsolutePathNameForFeatures_WhenWriting_ThenWarnWhenPathIsNotInSubFolderOfMduFolder()
        {
            ...
            var modelDefinition = new WaterFlowFMModelDefinition(mduDir, modelName);
            var allFixedWeirsAndCorrespondingProperties = new List<ModelFeatureCoordinateData<FixedWeir>>();
            TestHelper.AssertAtLeastOneLogMessagesContains(() => mduFile.Write(mduFilePath, modelDefinition, area, null, null,null, null, null, allFixedWeirsAndCorrespondingProperties), ", because the group name is invalid. Remove any occurences of");
