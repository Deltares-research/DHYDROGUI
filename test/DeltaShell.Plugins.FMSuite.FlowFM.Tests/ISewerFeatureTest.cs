...
namespace DeltaShell.Plugins.FMSuite.FlowFM.Tests
{
    ...
    public class ISewerFeatureTest : SewerFeatureFactoryTestHelper
    {
        ...
        public void GivenSimpleSewerNetwork_WhenAddingCompartmentWithDuplicateName_ThenReplaceExistingCompartmentWithNewCompartment(string parentManholeId)
        {
            ...
            Assert.That(network.Manholes.Sum(m => m.Compartments.Count), Is.EqualTo(2));
        ...
        public void GivenEmptyNetwork_WhenAddingOutletCompartmentToNetwork_OutletCompartmentIsPresentInNetworkWithCorrectValues()
        {
            ...
            Assert.That(manhole.Geometry, Is.EqualTo(outletGeometry));
        ...
        public void GivenNetwork_WhenAddingSewerConnectionToNetwork_ThenIsPresentInTheNetwork()
        {
            ...
            Assert.That(sewerConnection.Network, Is.EqualTo(network));
        }
        ...
        public void GivenSewerNetworkWithTwoManholes_WhenAddingSewerConnectionToNetwork_ThenCoordinatesAreSet()
        {
            ...
            var sourceManholeInNetwork = network.Manholes.FirstOrDefault(m => m.ContainsCompartmentWithName(sourceCompartmentName));
            var targetManholeInNetwork = network.Manholes.FirstOrDefault(m => m.ContainsCompartmentWithName(targetCompartmentName));
            Assert.IsNotNull(sourceManholeInNetwork);
            ...
            Assert.That(sewerConnectionGeometryCoordinates[0].X, Is.EqualTo(sourceCompartmentInNetwork.Geometry.Coordinate.X));
            Assert.That(sewerConnectionGeometryCoordinates[0].Y, Is.EqualTo(sourceCompartmentInNetwork.Geometry.Coordinate.Y));
            Assert.That(sewerConnectionGeometryCoordinates[1].X, Is.EqualTo(targetCompartmentInNetwork.Geometry.Coordinate.X));
            Assert.That(sewerConnectionGeometryCoordinates[1].Y, Is.EqualTo(targetCompartmentInNetwork.Geometry.Coordinate.Y));
        }
        ...
        public void GivenNetworkWithSharedCrossSection_WhenAddingPipeToNetwork_ThenSharedCrossSectionIsAddedToSewerConnection()
        {
            ...
            var pipeInNetwork = network.Pipes.FirstOrDefault();
        ...
        public void GivenSewerNetworkWithTwoManholesAndOneOrifice_WhenAddingOrificeWithSameIdToNetwork_ThenTheCorrectValuesHaveBeenSet()
        {
            ...
            var sewerConnectionInNetwork = network.SewerConnections.FirstOrDefault();
            Assert.IsNotNull(sewerConnectionInNetwork);
