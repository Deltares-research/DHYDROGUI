...
namespace DeltaShell.NGHS.IO.Tests.FileWriters.CrossSectionDefinition
{
    ...
    public class CrossSectionDefinitionIniCategoryGeneratorFactoryTest
    {
        ...
        {
            var generator = DefinitionIniCategoryGeneratorFactory.GetCrossSectionDefinitionIniSectionGenerator(CrossSectionStandardShapeType.Circle);
        ...
        {
            var generator = DefinitionIniCategoryGeneratorFactory.GetCrossSectionDefinitionIniSectionGenerator(CrossSectionStandardShapeType.Elliptical);
        ...
        {
            var generator = DefinitionIniCategoryGeneratorFactory.GetCrossSectionDefinitionIniSectionGenerator(CrossSectionStandardShapeType.Rectangle);
        ...
        {
            var categoryGenerator = DefinitionIniCategoryGeneratorFactory.GetCrossSectionDefinitionIniSectionGenerator(CrossSectionStandardShapeType.Rectangle);
            ...
            var iniSection = categoryGenerator.CreateDefinitionRegion(csdStd, true, "");
        ...
        {
            var generator = DefinitionIniCategoryGeneratorFactory.GetCrossSectionDefinitionIniSectionGenerator(CrossSectionStandardShapeType.Egg);
        ...
        {
            var generator = DefinitionIniCategoryGeneratorFactory.GetCrossSectionDefinitionIniSectionGenerator(CrossSectionStandardShapeType.Arch);
        ...
        {
            var generator = DefinitionIniCategoryGeneratorFactory.GetCrossSectionDefinitionIniSectionGenerator(CrossSectionStandardShapeType.Cunette);
        ...
        {
            var generator = DefinitionIniCategoryGeneratorFactory.GetCrossSectionDefinitionIniSectionGenerator(CrossSectionStandardShapeType.SteelCunette);
        ...
        {
            var generator = DefinitionIniCategoryGeneratorFactory.GetCrossSectionDefinitionIniSectionGenerator(CrossSectionStandardShapeType.Trapezium);
