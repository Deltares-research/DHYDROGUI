...
{
    [TestFixture]
    public class SpatialFileDataConverterTest
    {
        ...
        public void SetUp()
        {
            originalNetwork = FileWriterTestHelper.SetupSimpleHydroNetworkWith2NodesAndMaasmondBranch();
        ...
        public void GivenAListOfDelftIniCategories_WhenConverting_ThenANetworkCoverageIsReturned()
        {
            ...
            var networkCoverage = SpatialFileDataConverter.Convert(categories, channelsList, errorMessages);
            ...
            GivenACategoryWithAnSpatialRegion_WhenDuringConvertToSpatialDataTheBranchIsNull_ThenAnErrorMessageIsThrown()
        {
            ...
            SpatialFileDataConverter.Convert(categories, incorrectChannelsList, errorMessages);
