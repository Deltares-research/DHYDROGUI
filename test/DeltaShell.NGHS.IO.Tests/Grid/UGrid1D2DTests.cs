...
namespace DeltaShell.NGHS.IO.Tests.Grid
{
    ...
    public class UGrid1D2DTests
    {
        ...
        public void CreateLinksFrom2dFile()
        {
            ...
            string c_path = TestHelper.GetTestFilePath(@"ugrid\Custom_Ugrid.nc");
            ...
            int meshid = 1;
            ierr = gridWrapper.get_2d_mesh_id(ioncid, ref meshid);
            Assert.That(ierr, Is.EqualTo(0));

            //3. get the dimensions of the 2d mesh
            GridGeomWrapper.meshgeomdim meshtwoddim = new GridGeomWrapper.meshgeomdim();
            ierr = gridGeomWrapper.get_meshgeom_dim(ioncid, meshid, ref meshtwoddim);
            Assert.That(ierr, Is.EqualTo(0));
            ...
            GridGeomWrapper.meshgeom meshtwod = new GridGeomWrapper.meshgeom();
            ...
            ierr = gridGeomWrapper.get_meshgeom(ioncid, meshid, ref meshtwod, includeArrays);
            Assert.That(ierr, Is.EqualTo(0));
