...
{
    [TestFixture]
    public class Ugrid1DWrapperTests
    {
        ...
        public void create1dUGRIDNetcdf()
        {
            ...
            try
            {
                ...
                var ierr = GridWrapper.ionc_create(c_path, ref mode, ref ioncid, ref iconvtype);
                ...
                Assert.IsTrue(File.Exists(localCopyOfTestFile));
                int ioncid = 0; //file variable 
                int mode = (int)GridApiDataSet.NetcdfOpenMode.nf90_write; //create in write mode
                var wrapper = new GridWrapper();
                var ierr = wrapper.ionc_open(localCopyOfTestFile, ref mode, ref ioncid, ref iconvtype, ref convversion);
                Assert.That(ierr, Is.EqualTo(0));
        ...
        public void read1dUGRIDNetcdf()
        {
            ...
            try
            {
                ...
                Assert.IsTrue(File.Exists(c_path));
                int ioncid = 0; //file variable 
                int mode = 0; //create in write mode
                ...
                */
                ...
                Assert.IsTrue(File.Exists(localCopyOfTestFile));
                int ioncid = 0; //file variable 
                int mode = (int)GridApiDataSet.NetcdfOpenMode.nf90_nowrite; //open in 'read' mode
                var wrapper = new GridWrapper();
                var ierr = wrapper.ionc_open(localCopyOfTestFile, ref mode, ref ioncid, ref iconvtype, ref convversion);
                Assert.That(ierr, Is.EqualTo(0));
