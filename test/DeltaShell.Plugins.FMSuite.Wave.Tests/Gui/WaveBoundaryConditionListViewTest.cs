    ...
    public class WaveBoundaryConditionListViewTest
    {
        ...
        public void ShowListView()
        {
            var f1 = new Feature2D
                {
                    Name = "boundary 1",
                    Geometry = new LineString(new [] {new Coordinate(0.0, 0.0), new Coordinate(1.0, 0.0)})
                };
            var f2 = new Feature2D
                {
                    Name = "boundary 2",
                    Geometry = new LineString(new [] {new Coordinate(0.0, 0.0), new Coordinate(0.0, 1.0)})
                };
            var f3 = new Feature2D
                {
                    Name = "boundary 3",
                    Geometry = new LineString(new [] {new Coordinate(1.0, 1.0), new Coordinate(1.0, 0.0)})
                };
        ...
        {
            var sp2FilePath = TestHelper.GetTestFilePath(@"boundaryFromSp2\Nest002.sp2");
            var model = new WaveModel
                {
