...
{
    [TestFixture]
    public class BoundarySectionConverterTest
    {
        ...
        {
            // Call
            void Call() => BoundarySectionConverter.Convert(null, "path");
        ...
        {
            // Call
            void Call() => BoundarySectionConverter.Convert(new IniSection("section"), null);
        ...
        {
            // Call
            void Call() => BoundarySectionConverter.Convert(new IniSection("section"), "path");
                                                                                    ...
                                                                                    SectionTestKeyValue<SpreadingImportType> spreadingImportData)
        {
            ...
            // Call
            BoundaryMdwBlock result = BoundarySectionConverter.Convert(section, "path");
                                                                               ...
                                                                               string spreadingTypeStr)
        {
            ...
            // Call
            BoundaryMdwBlock result = BoundarySectionConverter.Convert(section, @"C:\path\to\mdw");
