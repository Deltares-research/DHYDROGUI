...
namespace DeltaShell.Plugins.FMSuite.Wave.Tests.Validation
{
    ...
    public class WaveBoundaryConditionValidatorTest
    {
        ...
        private readonly Feature2D featureWithThreePoints = new Feature2D
        {
            Geometry = new LineString(new[]
            {
                new Coordinate(0, 0),
        ...
        {
            // Given
            var boundaryCondition = new WaveBoundaryCondition(BoundaryConditionDataType.Constant) {Feature = featureWithTwoPoints};
        ...
        public void GivenWaveBoundaryConditionThatHasGeometryWithMoreThanTwoPoints_WhenValidatingBoundaryConditions_ThenInfoMessageIsReturned()
        {
            ...
            // Then
            string expectedMessage = Resources.WaveBoundaryConditionValidator_ValidateBoundaryCondition_Boundary_condition_contains_internal_geometry_points;
        ...
        public void GivenWaveBoundaryConditionThatHasSpatialVaryingSpatialDefinitionType_WhenValidatingBoundaryConditions_ThenInfoMessageIsReturned()
        {
            ...
            // Then
            string expectedMessage = Resources.WaveBoundaryConditionValidator_ValidateBoundaryCondition_Boundary_condition_contains_unactivated_support_points;
            ContainsOnlyOneIssueWithMessage(validationReport, ValidationSeverity.Info, expectedMessage);
        }
        ...
        public void ValidationSynchronizeTimePoints_WhenSpatialDefinitionIsSpatiallyVarying_TimePointsShouldBeEqual()
        {
            ...
            IEventedList<IVariable> functionOneComponents = boundaryCondition.PointData[0].Components;
            ...
            boundaryCondition.PointData[1].Arguments[0].SetValues(new[]
            {
                t1,
                t2
            });
            IEventedList<IVariable> functionTwoComponents = boundaryCondition.PointData[1].Components;
            ...
            var waveBoundaryConditions = new List<WaveBoundaryCondition> {boundaryCondition};
            ValidationIssue[] errors = WaveBoundaryConditionValidator.Validate(waveBoundaryConditions).AllErrors.ToArray();
        ...
        public void GivenJonswapWaveBoundaryConditionWithPeakEnhancementFactorNotWithinExpectedRange_WhenValidatingBoundaryConditions_ThenValidationErrorIsReturned(double peakEnhancementFactor)
        {
            ...
            // Then
            string expectedMessage = Resources.WaveBoundaryConditionValidator_ValidateSpectralData_Peak_Enhancement_Factor_must_be_a_value_within_the_range_1___10_;
            ContainsOnlyOneIssueWithMessage(validationReport, ValidationSeverity.Error, expectedMessage);
        }
        ...
        public void GivenSpatiallyVaryingTimeSeriesWaveBoundaryConditionThatHasNoTableEntries_WhenValidatingBoundaryConditions_ThenErrorMessageIsReturnedForSeparateDataPoints(WaveBoundaryConditionSpatialDefinitionType spatialDefinitionType)
        {
            ...
            // Then
            string expectedMessage = ConstructExpectedMessage(boundaryCondition.SpatialDefinitionType, Resources.WaveBoundaryConditionValidator_ValidateBoundaryCondition_Boundary_does_not_contain_a_boundary_condition);
            ContainsOnlyOneIssueWithMessage(validationReport, ValidationSeverity.Error, expectedMessage);
        }
        ...
        public void GivenWaveBoundaryConditionThatHasADataPointWithHeightNotInExpectedRange_WhenValidatingBoundaryConditions_ThenErrorMessageIsReturned(double heightValue, WaveBoundaryConditionSpatialDefinitionType type)
        {
            ...
            // Then
            string expectedMessage = ConstructExpectedMessage(boundaryCondition.SpatialDefinitionType, Resources.WaveBoundaryConditionValidator_ValidateBoundaryCondition__Parameter__Height__must_be_greater_than_0_and_smaller_or_equal_to_25_);
            ContainsOnlyOneIssueWithMessage(validationReport, ValidationSeverity.Error, expectedMessage);
        }
        ...
        public void GivenWaveBoundaryConditionThatHasADataPointWithPeriodNotInExpectedRange_WhenValidatingBoundaryConditions_ThenErrorMessageIsReturned(double periodValue, WaveBoundaryConditionSpatialDefinitionType type)
        {
            ...
            // Then
            string expectedMessage = ConstructExpectedMessage(boundaryCondition.SpatialDefinitionType, Resources.WaveBoundaryConditionValidator_ValidateBoundaryCondition__Parameter__Period__must_be_a_value_within_the_range_);
            ContainsOnlyOneIssueWithMessage(validationReport, ValidationSeverity.Error, expectedMessage);
        }
        ...
        public void GivenWaveBoundaryConditionThatHasADataPointWithDirectionNotInExpectedRange_WhenValidatingBoundaryConditions_ThenErrorMessageIsReturned(double directionValue, WaveBoundaryConditionSpatialDefinitionType type)
        {
            ...
            // Then
            string expectedMessage = ConstructExpectedMessage(boundaryCondition.SpatialDefinitionType, Resources.WaveBoundaryConditionValidator_ValidateSpectrumParameters_Parameter__Direction__must_be_a_value_within_the_range__360___360_);
            ContainsOnlyOneIssueWithMessage(validationReport, ValidationSeverity.Error, expectedMessage);
        }
                ...
                WaveBoundaryConditionSpatialDefinitionType type, double spreadingValue)
        {
            ...
            // Then
            string expectedMessage = ConstructExpectedMessage(boundaryCondition.SpatialDefinitionType, Resources.WaveBoundaryConditionValidator_ValidateBoundaryCondition__Parameter__Spreading__must_be_a_value_within_the_range_1_800);
            ContainsOnlyOneIssueWithMessage(validationReport, ValidationSeverity.Error, expectedMessage);
        }
                ...
                WaveBoundaryConditionSpatialDefinitionType type, double spreadingValue)
        {
            ...
            // Then
            string expectedMessage = ConstructExpectedMessage(boundaryCondition.SpatialDefinitionType, Resources.WaveBoundaryConditionValidator_ValidateBoundaryCondition__Parameter__Spreading__must_be_a_value_within_the_range_2_180);
            ContainsOnlyOneIssueWithMessage(validationReport, ValidationSeverity.Error, expectedMessage);
        }
        ...
        public void GivenParameterizedSpectrumTimeSeriesBoundaryConditionThatHasHsValueSmallerThanOrEqualToZero_WhenValidatingBoundaryConditions_ThenErrorMessageIsReturned(double heightValue, WaveBoundaryConditionSpatialDefinitionType type)
        {
            ...
            // Then
            string expectedMessage = ConstructExpectedMessage(boundaryCondition.SpatialDefinitionType, Resources.WaveBoundaryConditionValidator_ValidateBoundaryCondition__Values_in_column__Hs__in_the_time_series_table_must_be_within_expected_range);
            ContainsOnlyOneIssueWithMessage(validationReport, ValidationSeverity.Error, expectedMessage);
        }
        ...
        public void GivenParameterizedSpectrumTimeSeriesBoundaryConditionThatHasTpValueSmallerThanOrEqualToZero_WhenValidatingBoundaryConditions_ThenErrorMessageIsReturned(double periodValue, WaveBoundaryConditionSpatialDefinitionType type)
        {
            ...
            // Then
            string expectedMessage = ConstructExpectedMessage(boundaryCondition.SpatialDefinitionType, Resources.WaveBoundaryConditionValidator_ValidateBoundaryCondition__Values_in_column__Tp__in_the_time_series_table_must_be_within_expected_range);
            ContainsOnlyOneIssueWithMessage(validationReport, ValidationSeverity.Error, expectedMessage);
        }
        ...
        public void GivenParameterizedSpectrumTimeSeriesBoundaryConditionThatHasDirectionValueSmallerThanOrEqualToZero_WhenValidatingBoundaryConditions_ThenErrorMessageIsReturned(double directionValue, WaveBoundaryConditionSpatialDefinitionType type)
        {
            ...
            // Then
            string expectedMessage = ConstructExpectedMessage(boundaryCondition.SpatialDefinitionType, Resources.WaveBoundaryConditionValidator_ValidateBoundaryCondition__Values_in_column__Direction__in_the_time_series_table_must_be_within_expected_range);
            ContainsOnlyOneIssueWithMessage(validationReport, ValidationSeverity.Error, expectedMessage);
        }
        ...
        public void GivenParameterizedSpectrumTimeSeriesBoundaryConditionWithPowerDirectionalSpreadingThatHasSpreadingValueNotWithinExpectedRange_WhenValidatingBoundaryConditions_ThenErrorMessageIsReturned(double spreadingValue, WaveBoundaryConditionSpatialDefinitionType type)
        {
            ...
            // Then
            string expectedMessage = ConstructExpectedMessage(boundaryCondition.SpatialDefinitionType, Resources.WaveBoundaryConditionValidator_ValidateBoundaryCondition__Values_in_column__Spreading__in_the_time_series_table_must_be_a_value_within_the_range_1_800);
            ContainsOnlyOneIssueWithMessage(validationReport, ValidationSeverity.Error, expectedMessage);
        }
        ...
        public void GivenParameterizedSpectrumTimeSeriesBoundaryConditionWithDegreesDirectionalSpreadingThatHasSpreadingValueNotWithinExpectedRange_WhenValidatingBoundaryConditions_ThenErrorMessageIsReturned(double spreadingValue, WaveBoundaryConditionSpatialDefinitionType type)
        {
            ...
            // Then
            string expectedMessage = ConstructExpectedMessage(boundaryCondition.SpatialDefinitionType, Resources.WaveBoundaryConditionValidator_ValidateBoundaryCondition__Values_in_column__Spreading__in_the_time_series_table_must_be_a_value_within_the_range_2_180);
            ContainsOnlyOneIssueWithMessage(validationReport, ValidationSeverity.Error, expectedMessage);
        }
        ...
        {
            boundaryCondition.AddPoint(0);
            IEventedList<IVariable> functionComponents = boundaryCondition.PointData[0].Components;
            boundaryCondition.PointData[0].Arguments[0].SetValues(new[]
            {
                DateTime.Now
            });
        ...
        private static string ConstructExpectedMessage(WaveBoundaryConditionSpatialDefinitionType spatialDefinitionType, string expectedErrorMessage)
        {
            string precedingText =
                spatialDefinitionType == WaveBoundaryConditionSpatialDefinitionType.SpatiallyVarying
                    ? "Point 1: "
                    : string.Empty;
            string expectedMessage = precedingText + expectedErrorMessage;
