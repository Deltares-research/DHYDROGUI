...
namespace General.tests
{
    ...
    public class IoNetcdfLibWrapper
    {
        ...
        public static extern int ionc_get_meshgeom_dll([In] ref int ioncid, [In] ref int meshid, [In] ref int networkid, [In, Out] ref GridWrapper.meshgeom meshgeom, [In] ref int start_index, [In] ref bool includeArrays);

        [DllImport(LibDetails.LIB_DLL_NAME, EntryPoint = "ionc_get_meshgeom_dim", CallingConvention = CallingConvention.Cdecl)]
        public static extern int ionc_get_meshgeom_dim_dll([In] ref int ioncid, [In] ref int meshid, [In] ref int networkid, [In, Out] ref GridWrapper.meshgeomdim meshgeomdim);
        ...
        public static extern int ionc_put_meshgeom_dll([In] ref int ioncid, [In,Out] ref int meshid, [In, Out] ref int networkid, [In] ref GridWrapper.meshgeom meshgeom, [In] ref GridWrapper.meshgeomdim meshgeomdim, [In] string c_meshname, [In] string c_networkName, [In] ref int start_index);
        ...
        public int ionc_write_1d_network_nodes(ref int ioncid, ref int networkid, ref IntPtr c_nodesX, ref IntPtr c_nodesY, [In] ref IntPtr ids, [In] ref IntPtr longNames, ref int nNodes)
        {
            return ionc_write_1d_network_nodes_dll(ref ioncid, ref networkid, ref c_nodesX, ref c_nodesY, ref ids, ref longNames, ref nNodes);
        }

        public int ionc_put_1d_network_branches(ref int ioncid, ref int networkid, ref IntPtr c_sourcenodeid,
            ref IntPtr c_targetnodeid, ref IntPtr ids, ref IntPtr longNames, ref IntPtr c_branchlengths,
            ref IntPtr c_nbranchgeometrypoints, ref int nBranches, ref int startIndex)
        {
            return ionc_put_1d_network_branches_dll(ref ioncid, ref networkid, ref c_sourcenodeid, ref c_targetnodeid, ref ids, ref longNames, ref c_branchlengths, ref c_nbranchgeometrypoints, ref nBranches, ref startIndex);
        }
        ...
        public int ionc_put_1d_mesh_discretisation_points(ref int ioncid, ref int networkid, ref IntPtr c_branchidx,
            ref IntPtr c_offset, ref IntPtr ids, ref IntPtr longNames, ref int nmeshpoints, ref int startIndex)
        {
            return ionc_put_1d_mesh_discretisation_points_dll(ref ioncid, ref networkid, ref c_branchidx, ref c_offset, ref ids, ref longNames, ref nmeshpoints, ref startIndex);
        }

        public int ionc_put_1d_mesh_discretisation_points_v1(ref int ioncid, ref int networkid, ref IntPtr c_branchidx,
            ref IntPtr c_offset, [In] ref IntPtr ids, [In] ref IntPtr longNames, ref int nmeshpoints, ref int startIndex, ref IntPtr c_coordx, ref IntPtr c_coordy)
        {
            return ionc_put_1d_mesh_discretisation_points_v1_dll(ref ioncid, ref networkid, ref c_branchidx, ref c_offset, ref ids, ref longNames, ref nmeshpoints, ref startIndex, ref c_coordx, ref c_coordy);
        }
        ...
        public int ionc_get_1d_mesh_discretisation_points(ref int ioncid, ref int networkid, ref IntPtr c_branchidx,
            ref IntPtr c_offset, [In] ref IntPtr ids, [In] ref IntPtr longNames, ref int nmeshpoints, ref int startIndex)
        {
            return ionc_get_1d_mesh_discretisation_points_dll(ref ioncid, ref networkid, ref c_branchidx,
                ref c_offset, ref ids, ref longNames, ref nmeshpoints, ref startIndex);
        }
        ...
        public int ionc_put_mesh_contact(ref int ioncid, ref int contactsmesh, ref IntPtr c_mesh1indexes, ref IntPtr c_mesh2indexes, ref IntPtr c_contacttype, [In] ref IntPtr ids, [In] ref IntPtr longNames, ref int ncontacts, ref int startIndex)
        {
            return ionc_put_mesh_contact_dll(ref ioncid, ref contactsmesh, ref c_mesh1indexes, ref c_mesh2indexes, ref c_contacttype, ref ids, ref longNames, ref ncontacts, ref startIndex);
        }
        ...
        public int ionc_get_mesh_contact(ref int ioncid, ref int contactsmesh, ref IntPtr c_mesh1indexes, ref IntPtr c_mesh2indexes, ref IntPtr c_contacttype, [In] ref IntPtr ids, [In] ref IntPtr longNames, ref int ncontacts, ref int startIndex)
        {
        ...
        public int ionc_get_meshgeom(ref int ioncid, ref int meshid, ref int networkid, ref GridWrapper.meshgeom meshgeom, ref int start_index, ref bool includeArrays)
        {
            return ionc_get_meshgeom_dll(ref ioncid, ref meshid, ref networkid, ref meshgeom, ref start_index, ref includeArrays);
        }

        public int ionc_get_meshgeom_dim(ref int ioncid, ref int meshid, ref int networkid, ref GridWrapper.meshgeomdim meshgeomdim)
        {
        ...
        public int ionc_put_var_chars(ref int ioncid, ref int meshid, StringBuilder varname, ref IntPtr ids, ref IntPtr longNames, ref int nvalues)
        {
            return ionc_put_var_chars_dll(ref ioncid, ref meshid, varname, ref ids, ref longNames, ref nvalues);
        }

        public int ionc_get_var_chars(ref int ioncid, ref int meshid, StringBuilder varname, ref IntPtr ids, ref IntPtr longNames, ref int nvalues)
        {
            return ionc_get_var_chars_dll(ref ioncid, ref meshid, varname, ref ids, ref longNames, ref nvalues);
        }

        public int ionc_put_meshgeom(ref int ioncid, ref int meshid, ref int networkid, ref GridWrapper.meshgeom meshgeom, ref GridWrapper.meshgeomdim meshgeomdim, string c_meshname, string c_networkName, ref int start_index)
        {
