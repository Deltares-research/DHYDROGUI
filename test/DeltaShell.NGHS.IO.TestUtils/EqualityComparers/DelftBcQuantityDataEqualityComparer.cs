...
{
    /// <summary>
    /// An equality comparer for <see cref="IDelftBcQuantityData"/>.
    /// </summary>
    public class DelftBcQuantityDataEqualityComparer : IEqualityComparer<IDelftBcQuantityData>
    {
        ...
        /// </returns>
        public bool Equals(IDelftBcQuantityData x, IDelftBcQuantityData y)
        {
        ...
        /// <inheritdoc/>
        public int GetHashCode(IDelftBcQuantityData obj)
        {
            unchecked
            {
