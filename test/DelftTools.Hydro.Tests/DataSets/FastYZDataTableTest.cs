...
namespace DelftTools.Hydro.Tests.DataSets
{
    ...
    public class FastYZDataTableTest
    {
        ...
        public void TestMemoryConsumption()
        {
            ...
            long memoryAfterCreate = GC.GetTotalMemory(true);
            ...
            long memoryAfterAddingRows = GC.GetTotalMemory(true);

            long consumptionPerTable = (memoryAfterCreate - memoryBefore) / numTables;
            long consumptionPerRow = (memoryAfterAddingRows - memoryAfterCreate) / numTables / numRows;
        ...
        public void AddAndChangeRowsCheckSorting()
        {
            ...
            Assert.AreEqual(new[]
            {
                ...
                100,
                120
            }, table.Rows.Select(r => r[0]).ToArray());
