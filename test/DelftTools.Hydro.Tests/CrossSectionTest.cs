...
namespace DelftTools.Hydro.Tests
{
    ...
    public class CrossSectionTest
    {
        ...
        public void DefaultDefinitionIsClonedWithHydroNetworkCopy()
        {
            ...
            ICrossSectionDefinition defaultDefinition = networkCopy.DefaultCrossSectionDefinition;
        ...
        public void ModifyingOneSectionUpdatesTheOther()
        {
            ...
            var section1 = new CrossSectionSection
            {
                MinY = 0,
                MaxY = 10,
                SectionType = sectionType
            };
            var section2 = new CrossSectionSection
            {
                MinY = 10,
                MaxY = 30,
                SectionType = sectionType
        ...
        public void ModifyingProfileUpdatesSections()
        {
            ...
            var section1Zw = new CrossSectionSection
            {
                MinY = 0,
                MaxY = 7,
                SectionType = sectionTypeZw
            };
            var section2Zw = new CrossSectionSection
            {
                MinY = 7,
                MaxY = 10,
                SectionType = sectionTypeZw
        ...
        public void ChangeInDefinitionUpdatesGeometry()
        {
            ...
            expectedGeometry = new LineString(new[]
            {
