...
namespace DelftTools.Hydro.Tests.Helpers
{
    ...
    public class CrossSectionValidatorTest
    {
        ...
        {
            ICrossSectionDefinition csDef = GetSimpleCrossSectionDefinition();
        ...
        {
            CrossSectionDefinitionZW csdZw = GetSimpleCrossSectionDefinitionZw();
            csdZw.AddSection(new CrossSectionSectionType {Name = CrossSectionDefinition.MainSectionName}, mainSectionWidth);
        ...
        public void GivenCrossSectionDefinitionThatIsNotOfTypeZw_WhenValidiatingFloodPlain1AndFloodPlain2_ThenCrossSectionPassesThisValidation(bool useCsdProxy)
        {
            ...
            crossSectionDefYz.AddSection(new CrossSectionSectionType {Name = CrossSectionDefinition.MainSectionName}, 10.0);
            ...
            crossSectionDefStandard.AddSection(new CrossSectionSectionType {Name = CrossSectionDefinition.MainSectionName}, 10.0);
