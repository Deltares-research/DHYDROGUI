...
namespace DelftTools.Hydro.Tests
{
    ...
    public class HydroNetworkExtensionsTest
    {
        ...
        public void TestEnsureCompositeBranchStructureNamesAreUnique()
        {
            ...
            var compositeStructureList = new IBranchFeature[]
            {
                compositeStructure1,
                compositeStructure2
            };
        ...
        public void EnsureCompositeBranchStructureNamesAreUniqueShouldBeFast()
        {
            ...
            List<CompositeBranchStructure> compositeStructureList = Enumerable.Range(1, 100000).Select(i => new CompositeBranchStructure("Test", 0)).ToList();
