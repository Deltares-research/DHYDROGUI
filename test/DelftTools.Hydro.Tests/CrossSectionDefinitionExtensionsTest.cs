...
namespace DelftTools.Hydro.Tests
{
    ...
    public class CrossSectionDefinitionExtensionsTest
    {
        ...
        public void GivenCrossSectionDefinition_WhenTryingToAddSectionWithDuplicateName_ThenLogMessageAndSectionIsNotAdded()
        {
            ...
            string expectedMessage = string.Format("Could not add CrossSectionSection with duplicate name '{0}'", Section1Name);
        ...
        public void GivenCrossSectionDefinition_WhenAddingMultipleSections_ThenSectionsAreAddedCorrectly()
        {
            ...
            CrossSectionSection section1 = csDef.Sections.FirstOrDefault(s => s.SectionType.Name == Section1Name);
            ...
            CrossSectionSection section2 = csDef.Sections.FirstOrDefault(s => s.SectionType.Name == Section2Name);
            ...
            CrossSectionSection section3 = csDef.Sections.FirstOrDefault(s => s.SectionType.Name == Section3Name);
        ...
        private bool CheckCrossSectionDefinitionSectionsAreCorrectlyFitted(CrossSectionDefinition crossSectionDefinition)
        {
            ...
            foreach (CrossSectionSection crossSectionSection in crossSectionDefinition.Sections)
            {
