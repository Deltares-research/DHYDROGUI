...
namespace DelftTools.Hydro.Tests
{
    ...
    public class CrossSectionDefinitionYZTest
    {
            ...
            GivenACrossSectionDefinitionYZWhereRoughnessPositionsDoNotMatchProfile_WhenRefreshSectionsWidths_ThenTheFirstAndLastRoughnessPositionsHaveChanged()
        {
            ...
            var crossSectionSection1 = new CrossSectionSection
            {
                MinY = 0.2,
                MaxY = 5.2
            };
            var crossSectionSection2 = new CrossSectionSection
            {
                MinY = 5.2,
                MaxY = 9.2
            };
        ...
        public void GetGeometryWithNoYZReturnsPoint()
        {
            ...
            IGeometry geometry = crossSection.GetGeometry(new CrossSection
            {
                Branch = branch,
                Chainage = 20.0
            });
        ...
        public void SetReferenceLevelYZTest()
        {
            ...
            List<double> yValues = crossSection.Profile.Select(p => p.Y).ToList();
        ...
        public void AutoClone()
        {
            ...
            CrossSectionDefinitionYZ csClone = TypeUtils.DeepClone(crossSection);
        ...
        public void Clone()
        {
            ...
            FastYZDataTable yzDataTable = crossSectionYZ.YZDataTable;
            FastYZDataTable cloneYZTable = clone.YZDataTable;
            Assert.AreEqual(yzDataTable.Rows.Count, cloneYZTable.Rows.Count);
            Assert.AreEqual(5.0, clone.Thalweg);
            for (var i = 0; i < yzDataTable.Count; i++)
            {
        ...
        public void CopyFrom()
        {
            ...
            var copyFrom = new CrossSectionDefinitionYZ {Thalweg = 1.0};
            ...
            FastYZDataTable yzDataTable = crossSectionYZ.YZDataTable;
            FastYZDataTable copyYZTable = copyFrom.YZDataTable;
        ...
        public void TestValidateCellValue()
        {
            ...
            // Setting Y':
            Utils.Tuple<string, bool> validationResult = crossSection.ValidateCellValue(1, 0, 2.0);
