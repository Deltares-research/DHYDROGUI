...
namespace DeltaShell.Plugins.DelftModels.RealTimeControl.Tests.ImportExport
{
    ...
    public class RealTimeControlTimeSeriesSetterTest
    {
        ...
        public void GivenTimeSeriesXmlObjectAndAControlGroupWithAMatchingTimeRule_WhenSetTimeSeriesIsCalled_ThenCorrectTimeSeriesIsSet()
        {
            ...
            var timeSeriesElements = CreateTimeSeriesElementList(RtcXmlTag.TimeRule, value1, value2);
        ...
        {
            // Given
            var timeSeriesElements = CreateTimeSeriesElementList(RtcXmlTag.TimeCondition, 0, 1);
        ...
        {
            // Given
            var timeSeriesElements = CreateTimeSeriesElementList(RtcXmlTag.StandardCondition, 0, 0);
        ...
        public void GivenTimeSeriesXmlObjectForAnIntervalRuleWithASignalIntervalType_WhenSetTimeSeriesIsCalled_ThenAWarningShouldBeGiven()
        {
            ...
            var timeSeriesElements = new List<TimeSeriesComplexType>
            {
                new TimeSeriesComplexType {header = new HeaderComplexType {locationId = locationId}}
            };
        ...
        {
            var locationId = CreateLocationId(tag);

            var timeSeriesElements = new List<TimeSeriesComplexType>
            {
                GetTimeSeriesElement(locationId, value1, value2)
            };
        ...
        private static TimeSeriesComplexType GetTimeSeriesElement(string locationId, double value1, double value2)
        {
            var ruleTimeSeriesElement = new TimeSeriesComplexType
            {
                header = new HeaderComplexType
                {
                    ...
                    {
                        unit = timeStepEnumStringType.minute,
                        multiplier = "30",
                        divider = "1"
                    },
                ...
                @event = new List<EventComplexType>
                {
