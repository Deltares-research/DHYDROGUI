...
namespace DeltaShell.Plugins.DelftModels.RealTimeControl.Tests.Engine
{
    ...
    public class RealTimeControlXmlGeneratorTest
    {
        ...
        private string DataResultXml(ConnectionPoint testInput, ConnectionPoint testOutput, bool addLookupSignal)
        {
            ...
            if (addLookupSignal) result += "<timeSeries id=\"/SetPointForPID\" />";
        ...
        public void GenerateXml_C1AndC2_Or_NotC1AndC3()
        {
            ...
            var strC1AndC2_Or_NotC1AndC3 =
                ...
                "</output>" +
                "</unitDelay>" +
                "</rule><rule><interval id=\"[IntervalRule]/Interval Test\"><settingBelow>0.2</settingBelow><settingAbove>0.3</settingAbove><settingMaxStep>0</settingMaxStep><deadbandSetpointAbsolute>0.1</deadbandSetpointAbsolute><input><x ref=\"EXPLICIT\">[Input]MeasureStationA/Water level</x><setpoint>[SP]/Interval Test</setpoint>" +
        ...
        public void GenerateXml_DirectionalCondition()
        {
            var expectedXml =
                ...
                "<general><description>RTC Model DeltaShell</description><poolRoutingScheme>Theta</poolRoutingScheme><theta>0.5</theta>" +
                "</general><components><component><unitDelay id=\"[Input]CondInputLocation/CondInputQuantityIdDelay\"><input><x>[Input]CondInputLocation/CondInputQuantityId</x>" +
        ...
        public void GenerateXml_LookupSignal()
        {
            var expectedXml =
                ...
                "</input><output><y>/SetPointForPID</y>" +
                "</output>" +
                "</lookupTable>" +
                "</rule><rule><pid id=\"/PIDRule Test\"><mode>PIDVEL</mode><settingMin>1.1</settingMin><settingMax>1.2</settingMax><settingMaxSpeed>1.3</settingMaxSpeed><kp>0.3</kp><ki>0.2</ki><kd>0.1</kd><input><x>[Input]MeasureStationA/Water level</x><setpointSeries>/PIDRule Test_SP</setpointSeries>" +
                ...
                "</condition><true><trigger><ruleReference>/PIDRule Test</ruleReference>" +
                "</trigger>" +
                "</true><false><trigger><ruleReference>/PIDRule Test</ruleReference>" +
                "</trigger>" +
        ...
        public void GetSTimeSeries()
        {
            ...
            var piTimeSeries =
                ...
                "<series><header><type>instantaneous</type><locationId>/PIDRule Test</locationId><parameterId>SP</parameterId><timeStep unit=\"hour\" multiplier=\"7\" divider=\"1\" /><startDate date=\"2000-01-01\" time=\"00:15:30\" /><endDate date=\"2001-02-03\" time=\"04:15:45\" /><missVal>-999.0</missVal><stationName /><units />" +
        ...
        public void GetSTimeSeriesReturnsDocumentWhenSetPointIsConstantOnlyInOneRuleTest()
        {
            ...
            Assert.AreEqual("/" + pidrule02TestName,
        ...
        public void HydraulicRuleWithTimeLagDataConfigGenerationTest()
        {
            ...
            var strDataConfigWithHydraulicRuleTimeLag =
                ...
                "</OpenMIExchangeItem>" +
                "</timeSeries><timeSeries id=\"[Status]/Trigger31\" /><timeSeries id=\"delayed[Input]MeasureStationA/Water level\" vectorLength=\"9\"><PITimeSeries><locationId>MeasureStationA</locationId><parameterId>Water level</parameterId>" +
                "</PITimeSeries>" +
                "</timeSeries>" +
                "</exportSeries>" +
                "</rtcDataConfig>";
        ...
        public void HydraulicRuleWithTimeLagToolsConfigGenerationTest()
        {
            ...
            var strHydraulicRuleTimeLag =
                header +
                "<general><description>RTC Model DeltaShell</description><poolRoutingScheme>Theta</poolRoutingScheme><theta>0.5</theta>" +
                "</general><components><component><unitDelay id=\"[Input]MeasureStationA/Water levelDelay\"><input><x>[Input]MeasureStationA/Water level</x>" +
                "</input><output><yVector>delayed[Input]MeasureStationA/Water level</yVector>" +
                "</output>" +
                "</unitDelay>" +
                "</component>" +
                "</components><rules><rule><lookupTable id=\"[HydraulicRule]/HydraulicRule\"><table><record x=\"0\" y=\"0\" />" +
                "</table><interpolationOption>BLOCK</interpolationOption><extrapolationOption>BLOCK</extrapolationOption><input><x ref=\"EXPLICIT\">delayed[Input]MeasureStationA/Water level[8]</x>" +
                "</input><output><y>[Output]WeirdWeir/Crest level</y>" +
                "</output>" +
                "</lookupTable>" +
                "</rule>" +
        ...
        public void IntervalRuleToolsConfigGenerationTest()
        {
            ...
            var strPid =
                ...
                "<setpoint>[SP]/Interval Test</setpoint>" +
                "</input>" +
                "<output>" +
                "<y>[Output]WeirdWeir/Crest level</y>" +
        ...
        public void TwoPidRulesSameOutputToolsConfigGenerationTest()
        {
            ...
            var strPid = header +
                         ...
                         "</output>" +
                         "</pid>" +
                         "</rule><rule><pid id=\"/PIDRule2 Test\"><mode>PIDVEL</mode><settingMin>1.1</settingMin><settingMax>1.2</settingMax><settingMaxSpeed>1.3</settingMaxSpeed><kp>0.3</kp><ki>0.2</ki><kd>0.1</kd><input><x>[Input]MeasureStationA/Water level</x><setpointSeries>/PIDRule2 Test_SP</setpointSeries>" +
                         ...
                         "</condition><true><trigger><ruleReference>/PIDRule Test</ruleReference>" +
                         "</trigger>" +
                         "</true><false><trigger><ruleReference>/PIDRule2 Test</ruleReference>" +
                         "</trigger>" +
                         "</false><output><status>[Status]/Trigger31</status>" +
                         "</output>" +
                         "</standard>" +
