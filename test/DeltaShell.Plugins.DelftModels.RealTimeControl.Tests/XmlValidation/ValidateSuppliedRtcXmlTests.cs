...
namespace DeltaShell.Plugins.DelftModels.RealTimeControl.Tests.XmlValidation
{
    ...
    public class ValidateSuppliedRtcXmlTests
    {
        ...
        public void ValidateGeneratedXml()
        {
            ...
            var toolsConfigXml = RealTimeControlXmlWriter.GetToolsConfigXml(XsdPath, new List<ControlGroup> { controlGroup });
            ...
            var dataConfigXml = RealTimeControlXmlWriter.GetDataConfigXml(XsdPath, model, new List<ControlGroup> { controlGroup }, null);
