...
namespace DeltaShell.Plugins.DelftModels.RealTimeControl.Tests.Domain
{
    ...
    public class HydraulicRuleTests
    {
        ...
        public void RuleHasOutputValidation()
        {
            ...
            var newExceptionCount = validationResult.Messages.Count();
        ...
        {
            var rule = new HydraulicRule();
            rule.Outputs.Add(new Output { ParameterName = "parameter", Feature = new RtcTestFeature() });
            var result = rule.Validate();
        ...
        {
            var rule = new HydraulicRule();
            rule.Inputs.Add(new Input { ParameterName = "parameter", Feature = new RtcTestFeature() });
            rule.Outputs.Add(new Output { ParameterName = "parameter", Feature = new RtcTestFeature() });
