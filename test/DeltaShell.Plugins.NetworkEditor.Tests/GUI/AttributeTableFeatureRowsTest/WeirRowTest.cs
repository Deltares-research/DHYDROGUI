...
{
    [TestFixture]
    public class WeirRowTest
    {
        [Test]
        public void Constructor_WithNullWeir_ThrowsArgumentNullException()
        {
            // Act
            void Call()
            {
                new WeirRow(null, new NameValidator());
            }
        ...
        public void SetName_InvalidName_OriginalNameIsPreserved()
        {
            ...
            var weir2D = new Weir { Name = "some_name" };
            var row = new WeirRow(weir2D, nameValidator);
