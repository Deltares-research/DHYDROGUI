...
namespace DeltaShell.Plugins.NetworkEditor.Tests
{
    public static class NetworkEditorTestHelper
    {
        public static IHydroNetwork CreateDemoNetwork(CrossSectionSectionType crossSectionSectionType)
        {
            ...
            INode node1 = new HydroNode
            {
                Name = "node1",
                Network = network
            };
            INode node2 = new HydroNode
            {
                Name = "node2",
                Network = network
            };
            INode node3 = new HydroNode
            {
                Name = "node3",
                Network = network
            };
            ...
            ICrossSection cs1 = CrossSectionHelper.AddXYZCrossSectionFromYZCoordinates(branch1, 50.0, yzCoordinates, "crs1");
            ICrossSectionDefinition crossSection1Def = cs1.Definition;
            ...
            ICrossSection cs2 = CrossSectionHelper.AddXYZCrossSectionFromYZCoordinates(branch2, 75.0, yzCoordinates2, "crs2");
            ICrossSectionDefinition crossSection2Def = cs2.Definition;
