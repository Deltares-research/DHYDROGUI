...
namespace DeltaShell.Plugins.NetworkEditor.Tests
{
    ...
    public class NetworkEditorMapLayerProviderTest
    {
        ...
        public void ShowMapLayerWithEnclosure()
        {
            ...
            {
                ILayer layer = MapLayerProviderHelper.CreateLayersRecursive(area.Enclosures, area, new List<IMapLayerProvider> {new NetworkEditorMapLayerProvider()});
        ...
        public void ShowMapLayerWithPump2D()
        {
            ...
            using (var mapView = new MapView())
            {
                ILayer layer = MapLayerProviderHelper.CreateLayersRecursive(area.Pumps, area, new List<IMapLayerProvider> {new NetworkEditorMapLayerProvider()});
                mapView.Map.Layers.Add(layer);
        ...
        public void ShowMapLayerWithGate2D()
        {
            ...
            using (var mapView = new MapView())
            {
                ILayer layer = MapLayerProviderHelper.CreateLayersRecursive(area.Weirs, area, new List<IMapLayerProvider> {new NetworkEditorMapLayerProvider()});
                mapView.Map.Layers.Add(layer);
        ...
        public void ShowMapLayerWithPump()
        {
            ...
            using (var mapView = new MapView())
            {
                ILayer layer = MapLayerProviderHelper.CreateLayersRecursive(network, null, new List<IMapLayerProvider>
                {
        ...
        {
            var basinLayer = (GroupLayer) MapLayerProviderHelper.CreateLayersRecursive(new DrainageBasin(), null, new List<IMapLayerProvider>
            {
                new NetworkEditorMapLayerProvider(),
                new SharpMapLayerProvider()
            });
            ...
            var networkLayer = (GroupLayer) MapLayerProviderHelper.CreateLayersRecursive(new HydroNetwork(), null, new List<IMapLayerProvider>
            {
                new NetworkEditorMapLayerProvider(),
                new SharpMapLayerProvider()
            });
        ...
        public void ShowMapLayerWithRoute()
        {
            ...
            network.Routes.Add(RouteHelper.CreateRoute(new INetworkLocation[]
            {
                new NetworkLocation(branch1, 2),
                new NetworkLocation(branch1, 8)
            }));
        ...
        public void AddingFeaturesToBranchAddsToVariousHydroNetworkLayers()
        {
            ...
            using (var mapView = new MapView())
            {
                ...
                ILayer hydroNodeLayer = ((GroupLayer) layer).Layers.First(l => l.DataSource.FeatureType == typeof(HydroNode));
                ...
                ILayer crossSectionLayer = ((GroupLayer) layer).Layers.First(l => l.DataSource.FeatureType == typeof(CrossSection));
        ...
        public void ShowHydroRegionWithDrainageBasinAndNetworkAndCatchmentLinkedToNode()
        {
            ...
            using (var mapView = new MapView())
            {
                ILayer layer = MapLayerProviderHelper.CreateLayersRecursive(region, null, new List<IMapLayerProvider>
                {
                    new NetworkEditorMapLayerProvider(),
                    new SharpMapLayerProvider()
                });
                ...
                ILayer linkLayer = ((GroupLayer) layer).Layers.First(l => l.DataSource != null && l.DataSource.FeatureType == typeof(HydroLink));
                linkLayer.DataSource.Add(new LineString(new[]
                {
                    catchment.Geometry.Centroid.Coordinate,
