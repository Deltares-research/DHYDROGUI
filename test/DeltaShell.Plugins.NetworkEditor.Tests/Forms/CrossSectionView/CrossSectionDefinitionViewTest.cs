...
namespace DeltaShell.Plugins.NetworkEditor.Tests.Forms.CrossSectionView
{
    ...
    public class CrossSectionDefinitionViewTest
    {
        ...
        public void PasteIntoTableOfZWCrossSection()
        {
            ...
            CrossSectionDefinitionViewModel viewModel = CrossSectionDefinitionViewModelProvider.GetViewModel(crossSection, hydroNetwork);
            ...
            ITableViewPasteController controller = tableView.PasteController;

            crossSection.BeginEdit(new DefaultEditAction("test"));
            controller.PasteLines(new[]
            {
                "0\t1\t1",
                "1\t1\t1",
                "2\t1\t1"
        ...
        public void DeleteCellWithZvalueShouldNotThrowWhenCausingDuplicatesTools9909()
        {
            ...
            TableView table = TypeUtils.GetField<CrossSectionDefinitionView, TableView>(crossSectionView, "tableView");
        ...
        public void PasteIntoTableOfYZCrossSectionCheckArgumentBasedOverwritingTools8968()
        {
            using (CultureUtils.SwitchToInvariantCulture())
            {
                ...
                Assert.AreEqual(new[]
                {
                    ...
                    100,
                    150
                }, crossSection.YZDataTable.OrderBy(r => r[0]).Select(r => r[0]).ToArray());
                Assert.AreEqual(new[]
                {
                    0,
                    0,
                    ...
                    5,
                    10
                }, crossSection.YZDataTable.OrderBy(r => r[0]).Select(r => r[1]).ToArray());
            }
        }
        ...
        public void PasteIntoTableAndVerify()
        {
            using (var clipboardMock = new ClipboardMock())
            {
                ...
                CrossSectionDefinitionViewModel viewModel = CrossSectionDefinitionViewModelProvider.GetViewModel(csDef, hydroNetwork);
        ...
        public void PasteNewValueIntoTableOfYZCrossSection()
        {
            ...
            Action<Form> shown = delegate
            {
                ...
                {
                    "0\t1\t1"
                }); //need a 0 value -> new value is default always with a 0 value -> thats the conflict
                controller.PasteLines(new[]
                {
                    "1000\t1\t1"
                });
        ...
        public void ShowWithProxyIsReadOnly()
        {
            ...
            CrossSectionDefinitionViewModel crossSectionViewModel = CrossSectionDefinitionViewModelProvider.GetViewModel(proxyDefinition, hydroNetwork);
        ...
        public void ShowEmptyCrossSection()
        {
            ...
            {
                CrossSectionSectionTypes = GetSectionTypesList(new[]
                {
                    "Main"
                })
            };

            CrossSectionDefinitionViewModel crossSectionViewModel = CrossSectionDefinitionViewModelProvider.GetViewModel(crossSection, hydroNetwork);
        ...
        public void ShowWithYZCrossSectionWithRoughnessSections()
        {
            ...
            IHydroNetwork network = NetworkEditorTestHelper.CreateDemoNetwork(mainType);
        ...
        public void ShowHistory()
        {
            ...
            var crossSection1 = new CrossSectionDefinitionYZ
            {
                Name = "maas1",
                Thalweg = 5
            };
            ...
            var crossSection2 = new CrossSectionDefinitionYZ
            {
                Name = "maas2",
                Thalweg = 0
            };
            ...
            var crossSection3 = new CrossSectionDefinitionYZ
            {
                Name = "maas3",
                Thalweg = 5
            };
            ...
            var crossSectionSection = new CrossSectionSection
            {
                MinY = 0,
                MaxY = 17,
        ...
        private static EventedList<CrossSectionSectionType> GetSectionTypesList(IEnumerable<string> names)
        {
            return new EventedList<CrossSectionSectionType>(
                names
                    .Select(name => new CrossSectionSectionType {Name = name}));
        }
