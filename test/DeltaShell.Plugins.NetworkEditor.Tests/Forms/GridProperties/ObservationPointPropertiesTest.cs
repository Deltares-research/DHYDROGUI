...
{
    [TestFixture]
    public class ObservationPointPropertiesTest
    {
        [Test]
        public void SetName_InvalidName_OriginalNameIsPreserved()
        {
            ...
            var data = new ObservationPoint { Name = "some_name" };
            data.AttachNameValidator(validator);
            var properties = new ObservationPointProperties { Data = data };
        ...
        {
            WindowsFormsTestHelper.ShowPropertyGridForObject(new ObservationPointProperties { Data = new ObservationPoint() });
        }
    }
}