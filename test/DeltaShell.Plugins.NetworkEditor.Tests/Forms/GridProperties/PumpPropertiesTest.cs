...
{
    [TestFixture]
    public class PumpPropertiesTest
    {
        [Test]
        public void SetName_InvalidName_OriginalNameIsPreserved()
        {
            ...
            var data = new Pump { Name = "some_name" };
            data.AttachNameValidator(validator);
            var properties = new PumpProperties { Data = data };
        ...
        {
            WindowsFormsTestHelper.ShowPropertyGridForObject(new PumpProperties { Data = new Pump() });
        }
    }
}