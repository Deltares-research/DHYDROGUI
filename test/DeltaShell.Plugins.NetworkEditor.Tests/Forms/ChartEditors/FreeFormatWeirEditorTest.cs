...
namespace DeltaShell.Plugins.NetworkEditor.Tests.Forms.ChartEditors
{
    ...
    public class FreeFormatWeirEditorTest
    {
        ...
        {
            Assert.AreEqual(8,
                            ((FreeFormatWeirShapeFeature) freeFormatWeirEditor.ShapeFeature).PolygonShapeFeature.Geometry.Coordinates.Length);
        }
        ...
        public void InsertAt()
        {
            ...
            IGeometry polygon = ((FreeFormatWeirShapeFeature) freeFormatWeirEditor.ShapeFeature).PolygonShapeFeature.Geometry;
        ...
        {
            double offset = weir.OffsetY;
            IPoint tracker = freeFormatWeirEditor.GetTrackerAt(25 + offset, 15, 0, 0);
