...
namespace DeltaShell.Plugins.NetworkEditor.Tests.Forms.SewerFeatureViews
{
    ...
    public class ManholeVisualisationControlTest
    {
        ...
        public void GivenManhole_WhenOpeningView_ThenOpenWithoutError()
        {
            ...
            pumpConnection.BranchFeatures.Add(new Pump{StartSuction = 2, StopSuction = 0, StartDelivery = 1, StopDelivery = -1});
            pumpConnection2.BranchFeatures.Add(new Pump{StartSuction = 2.5, StopSuction = .5, StartDelivery = 1.3, StopDelivery = -1.4});
            ...
            var connections = new List<ISewerConnection>
            {
                ...
                new SewerConnectionOrifice { SourceCompartment = compartment1, Source = manhole, TargetCompartment = compartment2, Target = manhole, Bottom_Level = 0},
                pumpConnection,
                pumpConnection2,
            };
