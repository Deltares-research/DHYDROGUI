...
namespace DeltaShell.Plugins.NetworkEditor.Tests.Forms.NetworkSideView
{
    ...
    {
        [Test]
        [ExpectedException(ExpectedException = typeof(InvalidOperationException), ExpectedMessage = "Network of added spatial data does not match network of the route.")]
        ...
        [Test]
        [ExpectedException(ExpectedException = typeof(InvalidOperationException), ExpectedMessage = "Network spatial data not known in sideview data.")]
