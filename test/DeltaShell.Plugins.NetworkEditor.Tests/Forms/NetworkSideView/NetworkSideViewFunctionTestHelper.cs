...
namespace DeltaShell.Plugins.NetworkEditor.Tests.Forms.NetworkSideView
{
    public static class NetworkSideViewFunctionTestHelper
    {
        ...
        {
            IFunction function = NetworkSideViewDataController.CreateRouteFunctionFromNetworkCoverage(route, source, new Unit());
        ...
        public static Network GetNetwork()
        {
            ...
            IBranch branch1 = new Branch(node1, node2, 100)
            {
                Geometry = geometry1,
                Name = "branch1"
            };
            IBranch branch2 = new Branch(node2, node3, 100)
            {
                Geometry = geometry2,
                Name = "branch2"
            };
