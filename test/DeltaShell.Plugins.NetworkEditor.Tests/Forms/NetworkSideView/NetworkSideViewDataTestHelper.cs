...
namespace DeltaShell.Plugins.NetworkEditor.Tests.Forms.NetworkSideView
{
    public class NetworkSideViewDataTestHelper
    {
        ...
        {
            NetworkSideViewDataController data = CreateDefaultViewData();
        ...
        public static void AddCrossSections(Channel branch1, Channel branch2)
        {
            ...
            ICrossSection cs1 = CrossSectionHelper.AddXYZCrossSectionFromYZCoordinates(branch1, 20.0, yzCoordinates);
            ...
            ICrossSection cs2 = CrossSectionHelper.AddXYZCrossSectionFromYZCoordinates(branch2, 50.0, yzCoordinates);
        }
