...
namespace DeltaShell.Plugins.NetworkEditor.Tests.Forms.NetworkSideView
{
    public class NetworkSideViewDataTestHelper
    {
        ...
        public static NetworkSideViewDataController CreateDefaultViewData(bool createCrossSections)
        {
            ...
            var branch1 = new Channel("branch1", node1, node2, 100.0) { Geometry = GeometryFromWKT.Parse("LINESTRING (0 0, 100 0)"), Id = 1 };
            var branch2 = new Channel("branch2", node2, node3, 200.0) { Geometry = GeometryFromWKT.Parse("LINESTRING (100 0, 300 0)"), Id = 2 };
