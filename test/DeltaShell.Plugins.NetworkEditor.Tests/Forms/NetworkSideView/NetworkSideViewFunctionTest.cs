...
namespace DeltaShell.Plugins.NetworkEditor.Tests.Forms.NetworkSideView
{
    ...
    public class NetworkSideViewFunctionTest
    {
        ...
        public void NegativeRoute()
        {
            ...
            Route route = RouteHelper.CreateRoute(new NetworkLocation(branch2, 90.0),
        ...
        public void GetMinMaxForRouteExceedingCoverage()
        {
            ...
            Route route = RouteHelper.CreateRoute(new NetworkLocation(network.Branches[0], 0.0)
        ...
        public void GetMinMaxForRouteSmallerThanCoverage()
        {
            ...
            Route route = RouteHelper.CreateRoute(new NetworkLocation(network.Branches[0], 30.0),
        ...
        public void GetMinMaxForReversedRoute()
        {
            ...
            IFunction function = NetworkSideViewDataController.CreateRouteFunctionFromNetworkCoverage(route, source, new Unit("bla"));
        ...
        public void FeaturesFilteredCorrectForRouteInFeatureCoverage()
        {
            ...
            source.Features.AddRange(new IFeature[]
            {
                weir,
                bridge,
                pump
            ...
            Route route = RouteHelper.CreateRoute(new NetworkLocation(branch, 70.0),
                                                  new NetworkLocation(branch, 10.0));

            IFunction function = NetworkSideViewDataController.CreateRouteFunctionFromFeatureCoverage(route, source, new Unit("bla"));

            IMultiDimensionalArray<double> chainagesMda = function.Arguments[0].GetValues<double>();
        ...
        public void RouteWithNoPointsInCoverage()
        {
            ...
            Route route = RouteHelper.CreateRoute(new NetworkLocation(network.Branches[0], 10.0),
