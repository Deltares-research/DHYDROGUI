...
namespace DeltaShell.Plugins.NetworkEditor.Tests.Forms
{
    ...
    public class NetworkLocationEditorMapControlTest
    {
        ...
        private readonly INetwork network = new HydroNetwork();

        private readonly VectorLayer branchLayer = new VectorLayer("branches");
        private readonly NetworkCoverageGroupLayer networkCoverageGroupLayer = new NetworkCoverageGroupLayer();
