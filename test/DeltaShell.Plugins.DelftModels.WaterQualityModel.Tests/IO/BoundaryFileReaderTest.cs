...
namespace DeltaShell.Plugins.DelftModels.WaterQualityModel.Tests.IO
{
    ...
    public class BoundaryFileReaderTest
    {
        ...
        public void ReadFromFlowFMBoundariesFileReturnsAllReadBoundaries()
        {
            ...
            var expectedCoordinateCounts = new[] { 2*105, 2*4, 2*3, 2*24, 2*1, 2*1 };
            var expectedCoordinates = new[]
            {
                null,
                new[]
                {
                    new Coordinate(629751.48224218,  4273342.11616655),   new Coordinate(629652.98730354,  4273299.40077900),
                    new Coordinate(630053.41258012,  4273366.14930817),   new Coordinate(629970.36795947,  4273375.18785627),
                    new Coordinate(629865.45841468,  4273373.01908793),   new Coordinate(629751.48224218,  4273342.11616655),
                    new Coordinate(629970.36795947,  4273375.18785627),   new Coordinate(629865.45841468,  4273373.01908793),
                },
                new[]
                {
                    new Coordinate(649711.71641119,  4182564.05982326),   new Coordinate(649744.14162055,  4182574.88896024),
                    new Coordinate(649687.29369493,  4182553.93225919),   new Coordinate(649711.71641119,  4182564.05982326),
                    new Coordinate(649665.52921436,  4182544.28489453),   new Coordinate(649687.29369493,  4182553.93225919),
                },
                null,
                new[]
                {
                    new Coordinate(623810.48544239, 4188405.03473900), new Coordinate(623822.73600663,  4188038.21285109)
                },
                new[]
                {
                    new Coordinate(626755.25000000, 4185725.75000000), new Coordinate(626924.12500000,  4185768.25000000)
                }
            };
            ...
            var expectedBoundaryNodeIDs = new[]
            {
            ...
            for (int index = 0; index < expectedBoundaries.Length; index++)
            {
                var boundaryName = expectedBoundaries[index];
                var boundary = boundaries.Keys.Single(b => b.Name == boundaryName);
                ...
                {
                    for (int i = 0; i < expectedCoordinates[index].Length; i++)
                    {
