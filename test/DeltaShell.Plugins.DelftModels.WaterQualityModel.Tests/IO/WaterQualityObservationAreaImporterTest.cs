...
namespace DeltaShell.Plugins.DelftModels.WaterQualityModel.Tests.IO
{
    ...
    public class WaterQualityObservationAreaImporterTest
    {
        ...
        public void DefaultConstructor_ExpectedValues()
        {
            ...
            CollectionAssert.AreEqual(new[]{typeof(WaterQualityObservationAreaCoverage)}, importer.SupportedItemTypes.ToArray());
        ...
        public void ImportItem_TargetIsWaterQualityObservationAreaCoverageWithoutSpatialOperations_AddSpatialOperationsBasedOnPolygonShapes()
        {
            ...
            var valueConverter = SpatialOperationValueConverterFactory.GetOrCreateSpatialOperationValueConverter(dataItem, target.Name);
            ...
            // call
            var result = importer.ImportItem(path, target);
