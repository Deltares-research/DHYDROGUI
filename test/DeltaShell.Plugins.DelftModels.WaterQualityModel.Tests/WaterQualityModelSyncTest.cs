...
namespace DeltaShell.Plugins.DelftModels.WaterQualityModel.Tests
{
    ...
    public class WaterQualityModelSyncTest
    {
        ...
        public void TestModelSyncAfterImportOfSubstanceProcessLibrary()
        {
            ...
            var firstProcessCoefficient = waterQualityModel.ProcessCoefficients.First();
        ...
        public void TestModelOutputSyncAfterAddingAndRemovingSubstanceForSubstanceCalculation()
        {
            ...
            var outputCoverages = waterQualityModel.GetOutputCoverages().ToArray();
        ...
        {
            var modelGrid = UnstructuredGridTestHelper.GenerateRegularGrid(2, 2, 10, 10);
            var waterQualityModel = new WaterQualityModel();

            SetNewGrid(waterQualityModel, modelGrid);

            var newGrid = UnstructuredGridTestHelper.GenerateRegularGrid(5, 5, 10, 10);

            var initialConditionCoverage = CreateUnstructuredGridCellCoverage(newGrid, 1.1);
            var processCoefficientCoverage = CreateUnstructuredGridCellCoverage(newGrid, 2.2);
            var dispersionCoverage = CreateUnstructuredGridCellCoverage(newGrid, 3.3);
        ...
        public void TestModelMonitoringOutputSyncAfterChangeOfMonitoringOutputLevelForSubstanceCalculation()
        {
            var waterQualityModel = new WaterQualityModel
            {
                ModelSettings = { MonitoringOutputLevel = MonitoringOutputLevel.None }
            };
            ...
            waterQualityModel.SubstanceProcessLibrary.Substances.Add(new WaterQualitySubstance { Name = "Substance", ConcentrationUnit = "" });
            ...
            var outputDataItems = waterQualityModel.DataItems.Where(di => di.Role.HasFlag(DataItemRole.Output) && !di.Hidden);
            Assert.AreEqual(4, outputDataItems.Count());
            Assert.AreEqual("Substances", outputDataItems.ElementAt(0).Name);
            var substanceDataItems = waterQualityModel.OutputSubstancesDataItemSet.DataItems.Where(di => di.Role.HasFlag(DataItemRole.Output) && !di.Hidden);
        ...
        public void TestModelMonitoringOutputSyncAfterAddingAndRemovingSubstanceForSubstanceCalculation()
        {
            var waterQualityModel = new WaterQualityModel
            {
                ModelSettings =
                    {
                        MonitoringOutputLevel = MonitoringOutputLevel.Points
                    }
            };
            ...
            waterQualityModel.SubstanceProcessLibrary.OutputParameters.Add(new WaterQualityOutputParameter { Name = "Output parameter", ShowInHis = true });

            // Manually add two observation variable outputs with a dummy output parameter time series
            waterQualityModel.ObservationVariableOutputs.Add(new WaterQualityObservationVariableOutput(new[] { new Tuple<string, string>("Output parameter", "") }) { Name = "O1" });
            waterQualityModel.ObservationVariableOutputs.Add(new WaterQualityObservationVariableOutput(new[] { new Tuple<string, string>("Output parameter", "") }) { Name = "O2" });
        ...
        public void TestModelMonitoringOutputSyncAfterAddingAndRemovingOutputParameterForSubstanceCalculation()
        {
            ...
            var waterQualityOutputParameter1 = new WaterQualityOutputParameter { Name = "Output parameter 1", ShowInHis = false };
            var waterQualityOutputParameter2 = new WaterQualityOutputParameter { Name = "Output parameter 2", ShowInHis = true };
            var waterQualityOutputParameter3 = new WaterQualityOutputParameter { Name = "Output parameter 3", ShowInHis = true };
            ...
            waterQualityModel.ObservationVariableOutputs.Add(new WaterQualityObservationVariableOutput(new[] { new Tuple<string, string>("Substance", "") }) { Name = "O1" });
            waterQualityModel.ObservationVariableOutputs.Add(new WaterQualityObservationVariableOutput(new[] { new Tuple<string, string>("Substance", "") }) { Name = "O2" });
            Assert.IsTrue(waterQualityModel.ObservationVariableOutputs.All(ovo => ovo.TimeSeriesList.Count() == 1));
        ...
        public void TestModelMonitoringOutputSyncAfterChangeOfOutputParameterShowInHisForSubstanceCalculation()
        {
            var waterQualityModel = new WaterQualityModel
            {
                ModelSettings = { MonitoringOutputLevel = MonitoringOutputLevel.Points }
            };

            var waterQualityOutputParameter = new WaterQualityOutputParameter { Name = "Output parameter", ShowInHis = false };
            ...
            waterQualityModel.ObservationVariableOutputs.Add(new WaterQualityObservationVariableOutput(new Tuple<string, string>[] { }) { Name = "O1" });
            waterQualityModel.ObservationVariableOutputs.Add(new WaterQualityObservationVariableOutput(new Tuple<string, string>[] { }) { Name = "O2" });
        ...
        public void TestModelMonitoringOutputSyncAfterAddingAndRemovingObservationPointsForSubstanceCalculation()
        {
            ...
            waterQualityModel.SubstanceProcessLibrary.Substances.Add(new WaterQualitySubstance { Name = "Substance", ConcentrationUnit = "" });
            waterQualityModel.SubstanceProcessLibrary.OutputParameters.Add(new WaterQualityOutputParameter { Name = "Output parameter 1", ShowInHis = false });
            waterQualityModel.SubstanceProcessLibrary.OutputParameters.Add(new WaterQualityOutputParameter { Name = "Output parameter 2", ShowInHis = true });

            // Manually add a dummy observation variable output
            waterQualityModel.ObservationVariableOutputs.Add(new WaterQualityObservationVariableOutput(new Tuple<string, string>[] { }) { Name = "Dummy" });
        ...
        public void TestModelMonitoringOutputSyncAfterRenamingObservationPointsForSubstanceCalculation()
        {
            ...
            // Add an observation point
            var observationPoint = new WaterQualityObservationPoint {Name = "O1", Geometry = new Point(new Coordinate(0, 5))};
        ...
        public void TestUpdateSurfaceWaterTypeMonitoringOutputDataItemsForMonitoringOutputLevelAreas()
        {
            var waterQualityModel = new WaterQualityModel
            {
                ModelSettings = { MonitoringOutputLevel = MonitoringOutputLevel.Areas }
            };
            ...
            waterQualityModel.ObservationVariableOutputs.Add(new WaterQualityObservationVariableOutput(new Tuple<string, string>[] { }) { Name = "Surface water type 2" });
        ...
        {
            FunctionWrapper wrapper = new FunctionWrapper(functionList[0], functionList, dataOwner,
                new[]
                {
        ...
        private static void AssertConstantChangedToCoverage(IList<IFunction> functionList, double expectedDefaultValue)
        {
            ...
            var allDefaultValue = Enumerable.Repeat(expectedDefaultValue, functionList[0].Components[0].Values.Count).ToArray();
