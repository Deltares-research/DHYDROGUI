...
namespace Sobek.IntegrationTests
{
    ...
    public class UndoRedoHydroModelCentralMapIntegrationTest : UndoRedoCentralMapTestBase
    {
        ...
        [Test]
        public void AddRemoveRainfallRunoffModel()
        {
            onMainWindowShown = () =>
                {
                    var rrModel = new RainfallRunoffModel();
                    hydroModel.Activities.Add(rrModel);
                    hydroModel.Activities.Remove(rrModel);
                };
