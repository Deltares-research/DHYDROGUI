...
{
    [TestFixture]
    public class HisFileReaderTest
    {
        [Test]
        public void ReadHisFile()
        {
            ...
            Assert.AreEqual(refValues.Length, hisValues.Length);
        ...
        public void ReadOneTimeStep()
        {
            ...
            Assert.AreEqual(refValues.Length, lstTimeStepValues.Length);
        ...
        public void ReadOneLocation()
        {
            ...
            Assert.AreEqual(refValues.Length, lstLocationValues.Length);
        ...
        public void ReadTimeStepsHisFile()
        {
            ...
            Assert.AreEqual(new TimeSpan(0, 1, 0), timeSteps[1] - timeSteps[0]);
        }
    }
}
