    ...
    public class IniBackwardsCompatibilityHelperTest
    {
        ...
        public void IsUnsupportedPropertyValue_ArgNull_ThrowArgumentNullException(string section, string property, string value, bool expResult)
        {
            ...
            var config = new TestConfigurationValues
            {
                ...
                {
                    new IniPropertyInfo("some_section", "some_property", "some_value")
                }
            };
            var backwardsCompatibilityHelper = new IniBackwardsCompatibilityHelper(config);
        ...
        public void RemoveObsoletePropertiesWithWarning_RemovesObsoletePropertiesFromTheSectionAndLogsWarning()
        {
            ...
            var config = new TestConfigurationValues
            {
                ObsoleteProperties = new HashSet<string> { obsoletePropertyKey },
                ConditionalObsoleteProperties = new Dictionary<string, string>()
            };
            var backwardsCompatibilityHelper = new IniBackwardsCompatibilityHelper(config);
        ...
        public void UpdateProperty_WhenPropertyKeyNotInLegacyPropertyMapping_DoesNotUpdateProperty()
        {
            ...
            var legacyPropertyMapping = new Dictionary<string, NewPropertyData>
            {
                { "oldproperty", new NewPropertyData("newproperty", propertyUpdater) }
            };
        ...
        public void UpdateProperty_UpdatesProperty()
        {
            ...
            var legacyPropertyMapping = new Dictionary<string, NewPropertyData>
            {
                { randomKeyInMapping, new NewPropertyData(randomNewKey, propertyUpdater) }
            };
        ...
        private static IEnumerable<TestCaseData> GetUpdatedPropertyKeyData()
        {
            ...
            {
                LegacyPropertyMapping = new Dictionary<string, NewPropertyData>
                {
                    { "legacy_property", new NewPropertyData(expectedProperty, new DefaultPropertyUpdater()) }
                }
            };
        ...
        private static IEnumerable<TestCaseData> GetIsObsoletePropertyKeyData()
        {
            ...
            var configWithOnlyPropertyKey = new TestConfigurationValues
            {
                ObsoleteProperties = new HashSet<string>
                {
