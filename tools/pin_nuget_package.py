"""
Pins and tags a NuGet package on TeamCity.
...
def has_artifact_for_nuget_pkg(build_url: str, artifact_name: str, wrapper: RequestWrapper) -> bool:
    """
    ...
    return artifacts_response.json()['file'][0]['name'] == artifact_name


def get_new_build(build_config_id: str, artifact_name: str, wrapper: RequestWrapper) -> dict:
    """
...
def pin_nuget_package(artifact_name: str, build_id: str, tag: str, wrapper: RequestWrapper):
    """
    Pin and tag the build specified with build_info.
    ...
    if new_build_info:
        ...
        logging.warning(f"Could not find a build to tag NuGet package '{artifact_name}'.")
...
def parse_arguments():
    ...
    parser.add_argument("nuget_name", help="The name of the NuGet package to pin and tag.")
    parser.add_argument("nuget_version", help="The version of the NuGet package to pin and tag.")
    parser.add_argument("build_id", help="The id of the build configuration on TeamCity that publishes the specified NuGet package.")
    parser.add_argument("tag", help="The tag to pin the build of the specified NuGet package with.")
...
def run(nuget_name: str, nuget_version: str, build_id: str, tag: str, user: str, password: str):
    """
...
if __name__ == "__main__":
    ...
    run(args.nuget_name, args.nuget_version, args.build_id, args.tag,
